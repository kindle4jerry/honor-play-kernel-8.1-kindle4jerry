...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_FLASH_AGEING,       7884*1024, 512*1024,       EMMC_USER_PART},/* flash_ageing   512M    p66*/
  {PART_USERDATA,           8396*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G      p67*/
  #else
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_FLASH_AGEING,       7876*1024, 512*1024,       UFS_PART_3},/* flash_ageing     512M   p62*/
  {PART_USERDATA,           8388*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G       p63*/
  #else
