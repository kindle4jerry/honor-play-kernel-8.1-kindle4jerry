...
#ifdef AUDIO_FACTORY_MODE
	SOC_SINGLE_EXT("MAIN MICBIAS",
		HI6403_ANALOG_REG089, HI6403_MAINMIC_PD_BIT, 1, 0, hi6403_main_micbias_status_get, hi6403_main_micbias_status_put),
#endif
...
static int hi6403_platform_probe(struct platform_device *pdev)
{
	...
	if (!match) {
		...
		dev_info(dev, "%s : mic_num %d , use_stereo_smartpa %d, classh_rcv_hp_switch %d, hp_high_low_change_enable %d, hp_res_detect_enable %d, extern_hs_hifi_ak4376_I2S3 %d, gpio_pd_enable %d, ir_gpio_id %u hsd_cfg_enable %d bt_tri_gpio %d fm_enable %d\n",
