...
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OCP_LDO35)
...
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, CALI_LDO35_OCP)
...
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, CALI_LDO35_SHORT)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, CALI_PMUA_SHORT)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK0)
