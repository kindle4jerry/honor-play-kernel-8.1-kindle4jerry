...
#define HI6421V700_I_OUT_GATE       PMIC_I_OUT_GATE0_ADDR(0)
#define HI6421V700_I_IN_GATE      PMIC_I_IN_GATE0_ADDR(0)

#define HI6421V700_VOL_OFFSET_B_ADDR       PMIC_OTP0_59_W_ADDR(0)
...
#define HI6421V700_COUL_TEMP_DATA   PMIC_TEMP0_RDATA_ADDR(0)
#define HI6421V700_COUL_OCV_TEMP_DATA   PMIC_OCV_TEMP0_ADDR(0)
#define HI6421V700_COUL_ECOOUT_TEMP_DATA   PMIC_ECO_OUT_TEMP_0_ADDR(0)


#define HI6421V700_CURRENT                PMIC_CURRENT_0_ADDR(0)
#define HI6421V700_V_OUT                  PMIC_V_OUT_0_ADDR(0)
#define HI6421V700_CL_OUT_BASE            PMIC_CL_OUT0_ADDR(0)
#define HI6421V700_CL_IN_BASE             PMIC_CL_IN0_ADDR(0)
#define HI6421V700_CHG_TIMER_BASE         PMIC_CHG_TIMER0_ADDR(0)
#define HI6421V700_LOAD_TIMER_BASE        PMIC_LOAD_TIMER0_ADDR(0)
#define HI6421V700_CL_INT_BASE            PMIC_CL_INT0_ADDR(0)
#define HI6421V700_VOL_INT_BASE           PMIC_V_INT0_ADDR(0)
#define HI6421V700_OFFSET_CURRENT         PMIC_OFFSET_CURRENT0_ADDR(0)
#define HI6421V700_OFFSET_VOLTAGE         PMIC_OFFSET_VOLTAGE0_ADDR(0)
#define HI6421V700_OCV_VOLTAGE_BASE       PMIC_OCV_VOLTAGE0_ADDR(0)
#define HI6421V700_OCV_CURRENT_BASE       PMIC_OCV_CURRENT0_ADDR(0)
#define HI6421V700_ECO_OUT_CLIN_REG_BASE  PMIC_ECO_OUT_CLIN_0_ADDR(0)
#define HI6421V700_ECO_OUT_CLOUT_REG_BASE PMIC_ECO_OUT_CLOUT_0_ADDR(0)
#define HI6421V700_VOL_FIFO_BASE           PMIC_V_PRE0_OUT0_ADDR(0)
#define HI6421V700_CUR_FIFO_BASE          PMIC_CURRENT_PRE0_OUT0_ADDR(0)

#define HI6421V700_COUL_ECO_MASK          PMIC_COUL_ECO_MASK_ADDR(0)
...
#define HI6421V700_BATTERY_MOVE_ADDR      PMIC_HRST_REG0_ADDR(0)
#define BATTERY_MOVE_MAGIC_NUM            0xc3
#define BATTERY_PLUGOUT_SHUTDOWN_MAGIC_NUM 0x18

#define HI6421V700_OCV_CHOOSE             PMIC_HRST_REG1_ADDR(0) /*use bit5*/
#define HI6421V700_COUL_TEMP_PROTECT      PMIC_HRST_REG1_ADDR(0) /*use bit 4*/
#define HI6421V700_DELTA_RC_SCENE         PMIC_HRST_REG1_ADDR(0) /*use bit 3*/
#define HI6421V700_PD_BY_OCV_WRONG        PMIC_HRST_REG1_ADDR(0) /*use bit 2*/
#define HI6421V700_NV_READ_SUCCESS        PMIC_HRST_REG1_ADDR(0) /*use bit 1*/
#define HI6421V700_NV_SAVE_SUCCESS        PMIC_HRST_REG1_ADDR(0) /*use bit 0*/
...
#define HI6421V700_SAVE_OCV_ADDR          PMIC_HRST_REG2_ADDR(0) /*use 2byte,reserved3 and reserved4*/
#define HI6421V700_SAVE_OCV_RESERVED      PMIC_HRST_REG3_ADDR(0)
#define INVALID_TO_UPDATE_FCC             (0x8000)

#define HI6421V700_SAVE_OCV_TEMP_ADDR      PMIC_HRST_REG4_ADDR(0)/*OCV TEMP saved use 2bytes*/
#define HI6421V700_SAVE_OCV_TEMP_RESERVED  PMIC_HRST_REG5_ADDR(0)

/*record last soc*/
#define HI6421V700_SAVE_LAST_SOC  PMIC_HRST_REG6_ADDR(0)/*last soc 0-6bit */
#define HI6421V700_SAVE_LAST_SOC_VAILD  PMIC_HRST_REG6_ADDR(0)/*last soc vaild 7bit */
...
************************************************************/
#define HI6421V700_COUL_CTRL_REG         PMIC_CLJ_CTRL_REG_ADDR(0)
...
#define HI6421V700_CLJ_CTRL                PMIC_CLJ_CTRL_REGS2_ADDR(0)
...
#define HI6421V700_COUL_IRQ_REG          PMIC_COUL_IRQ_ADDR(0)//SOC_SMART_COUL_IRQ_ADDR(0)
#define HI6421V700_COUL_IRQ_MASK_REG     PMIC_COUL_IRQ_MASK_ADDR(0)//SOC_SMART_COUL_IRQ_MASK_ADDR(0)
...
#define HI6421V700_DEBUG_WRITE_PRO	PMIC_DEBUG_WRITE_PRO_ADDR(0)
...
#define HI6421V700_REG_READ(regAddr)             hisi_pmic_reg_read(regAddr)
