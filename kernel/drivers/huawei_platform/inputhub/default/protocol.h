...
typedef enum {
	...
	/* DUBAI */
	CMD_DUBAI_REQUEST_DATA,//0x4f
	CMD_DUBAI_REQUEST_DATA_RESP,
	CMD_DUBAI_SEND_TO_AP,
	CMD_DUBAI_SEND_TO_AP_RESP,
...
enum {
	...
	FILE_ID_MAX = 104,                       /* MAX VALID FILE ID */
};
