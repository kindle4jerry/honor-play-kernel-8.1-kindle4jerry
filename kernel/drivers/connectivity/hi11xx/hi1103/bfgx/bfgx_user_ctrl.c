...
STATIC ssize_t show_exception_dbg(struct device *dev, struct kobj_attribute *attr, int8 *buf)
{
    ...
    return snprintf(buf, SNPRINT_LIMIT_TO_KERNEL,
                        "==========cmd  func             \n"
                        "   1  close bt          \n"
...
STATIC ssize_t store_exception_dbg(struct device *dev, struct kobj_attribute *attr, const char *buf, size_t count)
{
    ...
    switch (cmd)
    {
        case 1:
            ...
            break;
        case 2:
            PS_PRINT_INFO("bfgx device timeout cause\n");
        ...
        case 4:
            ...
            break;
        case 5:
            PS_PRINT_INFO("powon dfr test en,next poweron will fail\n");
            set_excp_test_en(BFGX_POWEON_FAULT);
            break;
        case 6:
            PS_PRINT_INFO("powoff dfr test en,next poweroff will fail\n");
            set_excp_test_en(BFGX_POWEOFF_FAULT);
            break;
        case 7:
            PS_PRINT_INFO("wifi wkup dfr test en,next wkup will fail\n");
        ...
        case 8:
            ...
            PS_PRINT_INFO("bfgx device panic cause\n");
            ps_tx_sys_cmd(ps_core_d, SYS_MSG, SYS_CFG_DEV_PANIC);
            post_to_visit_node(ps_core_d);
            break;
        case 9:
            PS_PRINT_INFO("trigger hal ARP_TIMEOUT exception\n");
