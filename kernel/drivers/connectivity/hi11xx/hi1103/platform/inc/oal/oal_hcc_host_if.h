...
typedef oal_int32 (* hcc_rx_pre_do)(struct hcc_handler  *hcc, oal_uint8 stype, hcc_netbuf_stru* pst_netbuf, oal_uint8 **pre_do_context);
typedef oal_int32 (* hcc_rx_post_do)(struct hcc_handler  *hcc, oal_uint8 stype, hcc_netbuf_stru* pst_netbuf, oal_uint8 *pre_do_context);
...
OAL_STATIC OAL_INLINE oal_netbuf_stru* hcc_netbuf_alloc(oal_uint32 ul_size)
{
    ...
    pst_netbuf = __netdev_alloc_skb(NULL, ul_size + HCC_NETBUF_RESERVED_ROOM_SIZE, l_flags);
