...
OAL_STATIC oal_int32  wal_atcmsrv_ioctl_set_datarate(oal_net_device_stru *pst_net_dev, oal_int32 l_datarate)
{
    ...
    ***************************************************************************/
    ...
    else if ((WLAN_BAND_WIDTH_160PLUSPLUSPLUS <= g_l_bandwidth)
...
OAL_STATIC oal_int32  wal_atcmsrv_ioctl_lte_gpio_level_set(oal_int32 l_gpio_level)
{
...
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_ism_priority, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_level_set:SET ISM PRIORITY FAIL!");
        return l_ret;
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_lte_rx, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_lte_tx, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_lte_inact, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_ism_rx_act, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_bant_pri, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_bant_status, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_want_pri, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
    ...
    l_ret = wal_gpio_direction_output(g_st_wlan_customize.ul_want_status, l_gpio_level);
    if (OAL_SUCC != l_ret)
    {
...
OAL_STATIC oal_int32  wal_atcmsrv_ioctl_lte_gpio_level_check(oal_net_device_stru *pst_net_dev, oal_int32 l_gpio_level)
{
    ...
    {
        /*CHECK BIT_3 BIT_4*/
        if (0x18 == g_uc_dev_lte_gpio_level)
        {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_lte_gpio_level_check::check gpio high mode SUCC!}");
            l_ret = OAL_SUCC;
        }
...
OAL_STATIC oal_int32  wal_atcmsrv_ioctl_lte_gpio_set(oal_void)
{
...
#endif
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_ism_priority, WAL_ATCMDSRV_ISM_PRIORITY_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_ISM_PRIORITY mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_lte_rx, WAL_ATCMDSRV_LTE_RX_NAME);
    if (l_ret)
    {
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_lte_tx, WAL_ATCMDSRV_LTE_TX_NAME);
    if (l_ret)
    {
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_lte_inact, WAL_ATCMDSRV_LTE_INACT_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_ism_rx_act, WAL_ATCMDSRV_ISM_RX_ACT_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_bant_pri, WAL_ATCMDSRV_BANT_PRI_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_bant_status, WAL_ATCMDSRV_BANT_STATUS_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_want_pri, WAL_ATCMDSRV_WANT_PRI_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
    ...
    l_ret = wal_gpio_request_one(g_st_wlan_customize.ul_want_status, WAL_ATCMDSRV_WANT_STATUS_NAME);
    if (l_ret)
    {
        OAM_WARNING_LOG0(0, 0, "wal_atcmsrv_ioctl_lte_gpio_set:set LTE_TX_ACT mode gpio fail");
        return -OAL_EFAIL;
...
OAL_STATIC oal_void  wal_atcmsrv_ioctl_lte_gpio_free(oal_net_device_stru *pst_net_dev)
{
    ...
    oal_int32                       l_ret;
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
    wal_gpio_free(g_st_wlan_customize.ul_ism_priority);
    wal_gpio_free(g_st_wlan_customize.ul_lte_rx);
    wal_gpio_free(g_st_wlan_customize.ul_lte_tx);
    wal_gpio_free(g_st_wlan_customize.ul_lte_inact);
    wal_gpio_free(g_st_wlan_customize.ul_ism_rx_act);
    wal_gpio_free(g_st_wlan_customize.ul_bant_pri);
    wal_gpio_free(g_st_wlan_customize.ul_bant_status);
    wal_gpio_free(g_st_wlan_customize.ul_want_pri);
    wal_gpio_free(g_st_wlan_customize.ul_want_status);
#else
    gpio_free(WAL_ATCMDSRV_LTE_ISM_PRIORITY);
...
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_wipin_test::g_st_wlan_customize.ul_lte_gpio_check_switch is %d", g_st_wlan_customize.ul_lte_gpio_check_switch);
    /* 定制化是否检测lte共存管脚 */
...
oal_int32 wal_atcmsrv_ioctl_get_hw_status(oal_net_device_stru *pst_net_dev, oal_int32 *pl_fem_pa_status)
{
    ...
    {
        OAM_ERROR_LOG0(0, 0, "wal_atcmsrv_ioctl_get_hw_status::null ptr happened");
        return -OAL_EINVAL;
    }
    ...
    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status)|(pst_cali_data_c1->ul_check_hw_status << 4)|(ul_lte_status << 8));
    ...
    {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_hw_status::fem_pa_sta_c0[bit0-bit1 2g,bit2-bit3 5g],fem_pa_sta_c1[bit4-bit5 2g,bit6-7 5g],lte_gpio[bit8],ul_check_hw_status[0x%x]}", *pl_fem_pa_status);
        return -OAL_EINVAL;
    }
...
oal_void wal_atcmsrv_ioctl_get_fem_pa_status(oal_net_device_stru *pst_net_dev, oal_int32 *pl_fem_pa_status)
{
    ...
    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status)|(pst_cali_data_c1->ul_check_hw_status << 4));
    if(0 != *pl_fem_pa_status)
    {
        CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_WIFI_DEV(CHR_WIFI_DEV_EVENT_CHIP, CHR_WIFI_DEV_ERROR_FEM_FAIL));
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_fem_pa_status::fem_pa_sta_c0[bit0-bit1 2g,bit2-bit3 5g],fem_pa_sta_c1[bit4-bit5 2g,bit6-7 5g];ul_check_hw_status[0x%x]}", *pl_fem_pa_status);
    }
}
...
oal_int32  wal_atcmsrv_ioctl_get_fem_pa_status(oal_net_device_stru *pst_net_dev, oal_uint32 *pl_fem_pa_status)
{
    oal_int32                   l_ret;
    oal_int32                   i_leftime;
    wal_msg_write_stru          st_write_msg;
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != l_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_fem_pa_status::return err code %d!}\r\n", l_ret);
        return l_ret;
    }
    ...
    {
        /* 超时还没有上报扫描结束 */
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_fem_pa_status::reg wait for %ld ms timeout!}",
    ...
    {
        /* 定时器内部错误 */
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_fem_pa_status::reg wait for %ld ms error!}",
                         ((WAL_ATCMDSRB_NORM_TIME * 1000)/OAL_TIME_HZ));
    ...
    //if(0 != *pl_fem_pa_status)
    //{
    //    OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_get_fem_pa_status::ul_check_hw_status[0x%x]}", pst_hmac_vap->st_atcmdsrv_get_status.ul_check_fem_pa_status);
...
oal_int32 wal_atcmdsrv_wifi_priv_cmd(oal_int8 *ac_dev_name, oal_int32 ul_cmd, oal_uint8 * puc_param)
{
  ...
  //oal_uint8                        uc_cw_param;
    ...
    {
        ul_ret = wal_get_cmd_one_arg((oal_int8 *)puc_param, ac_dev_name_tmp, &ul_off_set);
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_atcmdsrv_wifi_priv_cmd::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
            return ul_ret;
        }
    }
    else
    ...
    switch(ul_cmd)
    {
        case WAL_ATCMDSRV_IOCTL_CMD_NORM_SET:
            l_ret = wal_hipriv_parse_cmd((oal_int8 *)puc_param);
            break;
        ...
        case WAL_ATCMDSRV_IOCTL_CMD_FEM_PA_INFO_GET:
            l_ret = wal_atcmsrv_ioctl_get_fem_pa_status(pst_net_dev, (oal_uint32 *)puc_param);
            break;
        case WAL_ATCMDSRV_IOCTL_CMD_RX_PCKG_GET:
            l_ret = wal_atcmsrv_ioctl_get_rx_pckg(pst_net_dev, (oal_int32 *)&ul_rx_pckg_succ_num);
            if (OAL_SUCC == l_ret)
            {
        ...
        case WAL_ATCMDSRV_IOCTL_CMD_VAP_UP_SET:
            l_ret = wal_netdev_open(pst_net_dev,OAL_FALSE);
            break;
        case WAL_ATCMDSRV_IOCTL_CMD_CHIPCHECK_SET:
