...
/* 用户pwr ref reg的定制化值 */
#define WAL_HIPRIV_PWR_REF_DELTA_HI         12
#define WAL_HIPRIV_PWR_REF_DELTA_LO         -12
...
extern oal_int32   wal_netdev_open(oal_net_device_stru *pst_net_dev,oal_uint8 uc_entry_flag);
