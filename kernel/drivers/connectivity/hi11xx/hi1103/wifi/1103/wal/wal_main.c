...
/*debug sysfs*/
    ...
    if (reg_at_hipriv_entry((hipriv_entry_t)wal_atcmdsrv_wifi_priv_cmd))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_main_init:: register at hipriv entry failed}\r\n");
    }
...
oal_void  wal_main_exit(oal_void)
{
    ...
    unreg_at_hipriv_entry((hipriv_entry_t)wal_atcmdsrv_wifi_priv_cmd);
#endif
#if defined(_PRE_CONFIG_CONN_HISI_SYSFS_SUPPORT) && (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
/*debug sysfs*/
