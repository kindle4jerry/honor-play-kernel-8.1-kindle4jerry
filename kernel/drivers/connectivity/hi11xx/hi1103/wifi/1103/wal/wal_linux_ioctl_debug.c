    ...
    switch(en_param_index)
    {
        ...
        case WAL_TX_POW_PARAM_SET_SAR_LEVEL:
            ...
            if (puc_sar_ctrl_params)
            {
                ...
                pst_set_tx_pow_param->auc_value[CUS_NUM_OF_SAR_PARAMS] = '\0';
            }
        #endif
            break;
...
OAL_STATIC oal_uint32 wal_hipriv_set_phy_debug_switch(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    do
    {
        ...
        {
            OAL_IO_PRINT("CMD format::sh hipriv.sh 'wlan0 phy_debug [rssi 0|1] [snr 0|1] [trlr xxxxx] [vect yyyyy] [count N]'");
            OAM_ERROR_LOG0(0, OAM_SF_CFG, "{CMD format::sh hipriv.sh 'wlan0 phy_debug [rssi 0|1] [snr 0|1] [trlr xxxxx] [vect yyyyy] [count N]'!!}\r\n");
            return ul_ret;
        }
        pc_param += ul_off_set;
        ul_off_set = 0;
        ...
        {
            OAL_IO_PRINT("CMD format::sh hipriv.sh 'wlan0 phy_debug [rssi 0|1] [snr 0|1] [trlr xxxxx] [vect yyyyy] [count N]'");
            OAM_WARNING_LOG0(0, OAM_SF_CFG, "{CMD format::sh hipriv.sh 'wlan0 phy_debug [rssi 0|1] [snr 0|1] [trlr xxxx] [vect yyyy] [count N]'!!}\r\n");
            return OAL_FAIL;
        }
    }while(*pc_param != '\0');
...
OAL_STATIC oal_uint32 wal_hipriv_btcoex_preempt_type(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if(0 != pst_btcoex_preempt_mgr->uc_cfg_preempt_mode && 1 != pst_btcoex_preempt_mgr->uc_cfg_preempt_mode)
    {
    ...
    if((0 == pst_btcoex_preempt_mgr->uc_cfg_preempt_mode && pst_btcoex_preempt_mgr->uc_cfg_preempt_type > 3)||
        (1 == pst_btcoex_preempt_mgr->uc_cfg_preempt_mode && pst_btcoex_preempt_mgr->uc_cfg_preempt_type > 255))
    {
        OAM_WARNING_LOG2(0, OAM_SF_COEX, "{wal_hipriv_btcoex_preempt_type:: uc_cfg_preempt_mode[%d] uc_cfg_preempt_type[%d]!}\r\n",
            pst_btcoex_preempt_mgr->uc_cfg_preempt_mode, pst_btcoex_preempt_mgr->uc_cfg_preempt_type);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_btcoex_set_perf_param(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    else if(1 == pst_btcoex_mgr->uc_cfg_btcoex_mode)
    {
        ...
        if((0 != pst_btcoex_mgr->uc_cfg_btcoex_type)&& (1 != pst_btcoex_mgr->uc_cfg_btcoex_type))
        {
             OAM_WARNING_LOG1(0, OAM_SF_COEX, "{wal_hipriv_btcoex_set_perf_param:: pst_btcoex_mgr->uc_cfg_btcoex_type error [%d], [0/1]!}\r\n",
        ...
        pst_btcoex_mgr->en_btcoex_nss = (wlan_nss_enum_uint8)oal_atoi(ac_name);

        if(pst_btcoex_mgr->en_btcoex_nss > WLAN_DOUBLE_NSS) /* 暂时只支持双流 */
        {
            OAM_WARNING_LOG1(0, OAM_SF_COEX, "{wal_hipriv_btcoex_set_perf_param:: pst_btcoex_mgr->en_btcoex_nss [%d] error!}\r\n",
                pst_btcoex_mgr->en_btcoex_nss);
            return OAL_ERR_CODE_INVALID_CONFIG;
        }
...
OAL_STATIC oal_uint32  wal_hipriv_waveapp_32plus_user_enable(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_waveapp_32plus_user_enable::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_profiling_packet_add(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    l_ret = wal_get_cmd_one_arg(pc_param, ac_name, &ul_off_set);
    if (OAL_SUCC != l_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_show_profiling::wal_get_cmd_one_arg return err_code [%d]!}\r\n", l_ret);
         return l_ret;
    ...
    *((oal_uint8 *)(st_write_msg.auc_value)) = ul_value;
    ...
    if (OAL_UNLIKELY(OAL_SUCC != l_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_profiling_packet_add::wal_send_cfg_event return err code [%d]!}\r\n", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_test_dfr_start(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    OAL_MEMZERO((oal_uint8 *)(g_st_dfr_info.past_netdev), OAL_SIZEOF(g_st_dfr_info.past_netdev[0]) * WLAN_VAP_SUPPORT_MAX_NUM_LIMIT);
...
OAL_STATIC oal_uint32  wal_hipriv_set_opmode_notify(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_OPMODE, "{wal_hipriv_set_opmode_notify::wal_get_cmd_one_arg return err_code %d!}\r\n", ul_ret);
        return ul_ret;
    }
...
oal_uint32  wal_hipriv_set_m2s_switch(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    switch (pst_m2s_mgr->en_cfg_m2s_mode)
    {
        ...
        case MAC_M2S_MODE_MSS:
            ...
            pst_m2s_mgr->pri_data.mss_mode.uc_m2s_mss_mode = (oal_uint8)oal_atoi(ac_name);
            if(pst_m2s_mgr->pri_data.mss_mode.uc_m2s_mss_mode >= MAC_M2S_COMMAND_MODE_BUTT)
            {
                OAM_WARNING_LOG1(0, OAM_SF_M2S, "{wal_hipriv_set_m2s_switch::pst_m2s_mgr->pri_data.mss_mode.uc_m2s_mss_mode error [%d] (<=4)!}\r\n",
                    pst_m2s_mgr->pri_data.mss_mode.uc_m2s_mss_mode);
                return OAL_ERR_CODE_INVALID_CONFIG;
            }

            return wal_ioctl_set_m2s_mss(pst_net_dev, pst_m2s_mgr->pri_data.mss_mode.uc_m2s_mss_mode);
        ...
        case MAC_M2S_MODE_RSSI:
            ...
            pst_m2s_mgr->pri_data.rssi_snr_mode.uc_ch = (oal_uint8)oal_atoi(ac_name);
            ...
            pst_m2s_mgr->pri_data.rssi_snr_mode.ul_value = oal_atoi(ac_name);
...
OAL_STATIC oal_uint32  wal_hipriv_set_isolation_type(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_set_isolation_type:wal_get_cmd_one_arg fail!}\r\n");
        return ul_ret;
    }
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_isolation_type::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != l_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_set_isolation_type:wal_send_cfg_event return[%d].}\r\n", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_dync_pow_debug_switch(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_dync_pow_debug_switch::wal_get_cmd_one_arg fails!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_11v_cfg_wl_mgmt(oal_net_device_stru *pst_cfg_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_BSSTRANSITION, "{wal_hipriv_11v_cfg_wl_mgmt::wal_get_cmd_one_arg return err_code %d!}\r\n", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_11v_tx_request(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_BSSTRANSITION, "{wal_hipriv_11v_tx_request::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    oal_strtoaddr(ac_name, auc_mac_addr);
    /***************************************************************************
...
OAL_STATIC oal_uint32  wal_hipriv_set_priv_flag(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg(pc_param, ac_flag, &ul_off_set);
    if (OAL_SUCC != ul_ret)
    {
   ...
   *pen_priv_flag = (oal_bool_enum_uint8)oal_atoi(ac_flag);
    ...
    if (OAL_SUCC != l_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_priv_flag::wal_send_cfg_event fail.return err code [%d]!}\r\n", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_stat_user_bsd(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_stat_user_bsd::wal_hipriv_get_mac_addr failed!}\r\n");
        return ul_ret;
    }
    oal_set_mac_addr(pst_stat_param->auc_mac_addr, auc_mac_addr);
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_stat_user_bsd::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
    pst_stat_param->us_stat_period = (oal_uint16)oal_atoi(ac_name);
...
OAL_STATIC oal_uint32  wal_hipriv_lpm_soc_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_lpm_soc_mode::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_send_frame(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    {
        ul_ret = wal_get_cmd_one_arg(pc_param,ac_str_frame_body,&ul_offset);
        if(OAL_SUCC != ul_ret)
        {
...
OAL_STATIC oal_uint32  wal_hipriv_m2u_tid_set(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_tid_set::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_m2u_del_deny_table(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_del_deny_table::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_m2u_show_snoop_deny_table(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_show_snoop_deny_table::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_m2u_frequency_on(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_frequency_on::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_m2u_adaptive_on(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_adaptive_on::wal_get_cmd_one_arg param1 return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_adaptive_on::wal_get_cmd_one_arg param2 return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_m2u_adaptive_on::wal_get_cmd_one_arg param3 return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_qos_enhance_on(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_qos_enhance_on::wal_get_cmd_one_arg return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_dyn_cali_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *puc_param)
{
    wal_msg_write_stru              st_write_msg;
    oal_uint32                      ul_off_set;
    oal_int8                        ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN];
...
OAL_STATIC oal_uint32 wal_hipriv_user_extend_enable(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    *((oal_bool_enum_uint8 *)(st_write_msg.auc_value)) = en_enable;
    ...
    if (OAL_UNLIKELY(OAL_SUCC != l_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_hipriv_user_extend_enable::wal_send_cfg_event return err code[%d]!\r\n", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_get_cali_data(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != l_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_get_cali_data::wal_send_cfg_event return err_code [%d]!}\r\n", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_packet_capture(oal_net_device_stru *pst_cfg_net_dev, oal_int8 *pc_param)
{
    ...
    */
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_packet_capture::wal_get_cmd_one_arg return err_code %d!}\r\n", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32  wal_hipriv_send_radio_meas_req(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_send_radio_meas_req::wal_hipriv_get_mac_addr failed!}\r\n");
        return ul_ret;
    }
...
OAL_CONST wal_hipriv_cmd_entry_stru  g_ast_hipriv_cmd_debug[] =
{
    ...
    {"wmmac_switch",            wal_hipriv_wmmac_switch},           /* 设置WMMAC开关，配置命令: hipriv "vap0 wmmac_switch 1/0(使能) 0|1(WMM_AC认证使能) AC xxx(limit_medium_time)  " 整个Device */
#endif
    ...
    {"coex_preempt_type",       wal_hipriv_btcoex_preempt_type},    /* 配置preempt_type，sh hipriv.sh "vap0 coex_preempt_type  0/1(硬件或者软件) 0-3/0-1"  0 noframe 1 self-cts 2 nulldata 3 qosnull  软件ps打开或者关闭 */
    {"set_coex_perf_param",     wal_hipriv_btcoex_set_perf_param},    /* 配置preempt_type，sh hipriv.sh "vap0 set_coex_perf_param  0/1/2/3" */
#endif
