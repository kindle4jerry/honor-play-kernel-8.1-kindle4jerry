...
typedef struct efuse_bits
{
    ...
    oal_uint32 reserved5;            //8 * 32 = 256bits
    oal_uint32 reserved6;
    oal_uint32 reserved7;
    oal_uint32 reserved8;
    oal_uint32 reserved9;
    oal_uint32 reserved10;
    oal_uint32 reserved11;
    oal_uint32 reserved12;
}wal_efuse_bits;
/************************** end ***************************/
...
extern oal_uint32 wal_regdomain_get_channel_5g(oal_uint32 ul_start_freq, oal_uint32 ul_end_freq);
extern oal_int32  hi1103_pcie_ip_test(oal_int32 test_count);
extern oal_int32 hi1103_dev_io_test(void);
extern oal_void hmac_dump_cali_result(oal_void);
#endif
