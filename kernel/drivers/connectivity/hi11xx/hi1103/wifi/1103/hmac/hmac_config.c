...
//    st_user_opmode.uc_frame_type      = uc_mgmt_frm_type;
    ...
    ul_relt = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_USER_M2S_INFO_SYN,
                                    OAL_SIZEOF(st_user_m2s),
                                    (oal_uint8 *)(&st_user_m2s));
    if (OAL_UNLIKELY(OAL_SUCC != ul_relt))
    {
        OAM_WARNING_LOG1(pst_mac_user->uc_vap_id, OAM_SF_CFG, "{hmac_config_update_user_m2s_event::hmac_config_send_event failed[%d].}", ul_relt);
        return ul_relt;
    }
...
oal_uint32  hmac_config_add_vap(mac_vap_stru *pst_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (WLAN_VAP_MODE_CONFIG != pst_param->en_vap_mode)
    {
        ...
        hmac_config_set_mac_addr(&(pst_hmac_vap->st_vap_base_info), us_mac_len, (oal_uint8*)&st_sta_id_param);
    }
#endif
...
oal_uint32  hmac_config_del_vap(mac_vap_stru *pst_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "hmac_config_del_vap::hmac_res_get_mac_chip id[%d] NULL",pst_device->uc_chip_id);
        return OAL_FAIL;
    }
    ...
    if ((WLAN_VAP_MODE_BSS_STA == pst_vap->en_vap_mode) && (0 == uc_vap_num))
    {
        ...
        if (OAL_ERR_CODE_FOBID_CLOSE_DEVICE != wlan_pm_close())
        {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{hmac_config_del_vap::hmac_config_host_dev_exit! pst_hmac_device[%d]}", pst_vap->uc_device_id);
...
oal_uint32  hmac_config_start_vap(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (WLAN_VAP_MODE_BSS_AP == pst_mac_vap->en_vap_mode)
    {
        ...
        if (IS_LEGACY_VAP(&(pst_hmac_vap->st_vap_base_info)))
        {
            ...
            if (hmac_calc_up_ap_num(pst_mac_device) < 2)
            {
                ...
                if(OAL_SUCC == hmac_init_scan_try(pst_mac_device, pst_mac_vap, MAC_TRY_INIT_SCAN_VAP_UP, &st_acs_cfg))
                {
                    return OAL_SUCC;
                }
            }
...
oal_uint32 hmac_config_down_vap(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAL_DLIST_SEARCH_FOR_EACH_SAFE(pst_entry, pst_dlist_tmp, &(pst_mac_vap->st_mac_user_list_head))
    {
        ...
        {
            OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_down_vap::pst_user_tmp null.}");
            continue;
        }
        ...
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_down_vap::pst_hmac_user_tmp null.idx:%u}",pst_user_tmp->us_assoc_id);
            continue;
        }
...
oal_uint32 hmac_config_sta_scan_wake_wow(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_STA_SCAN_CONNECT, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_PWR,
                       "{hmac_config_sta_scan_wake_wow::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
    pst_mac_vap->st_cap_flag.bit_11ac2g = (oal_uint8)!!hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_11AC2G_ENABLE);
...
oal_uint32  hmac_config_bg_noise_info(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_BG_NOISE, OAL_SIZEOF(oal_uint8), puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
...
oal_uint32  hmac_config_set_global_shortgi(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_mac_device)
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SCAN, "{hmac_config_set_global_shortgi::mac_res_get_dev fail.device_id = %u}",
                           pst_mac_vap->uc_device_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_priv_set_mode(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
    {
        ...
        /* 根据协议更新vap能力 */
        mac_vap_init_by_protocol(pst_vap, pst_prot_param->en_protocol);


        /***************************************************************************
         抛事件到DMAC层, 配置寄存器
        ***************************************************************************/
        ul_ret = hmac_set_mode_event(pst_vap);
        if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
        {
            OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_priv_set_mode::hmac_config_send_event failed[%d].}", ul_ret);
            return ul_ret;
        }
    }
...
oal_uint32  hmac_config_priv_set_channel(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_ERROR_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_priv_set_channel::mac_is_channel_num_valid[%d] failed[%d].}", uc_channel, ul_ret);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
...
#ifdef _PRE_WLAN_FEATURE_DFS
    /* 如果配置的信道被雷达占用，不可配置 */
    ul_err_code = mac_get_channel_idx_from_num(pst_mac_vap->st_channel.en_band, uc_channel, &uc_chan_idx);
    ...
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
    {
        ...
        ul_ret = mac_get_channel_idx_from_num(pst_vap->st_channel.en_band, uc_channel, &(pst_vap->st_channel.uc_chan_idx));
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG2(pst_vap->uc_vap_id,OAM_SF_CFG,"{hmac_config_priv_set_channel::mac_get_channel_idx_from_num fail.band[%u] channel[%u]!}",
        ...
        /***************************************************************************
            抛事件到DMAC层, 同步DMAC数据
        ***************************************************************************/
        ul_ret = hmac_config_send_event(pst_vap, WLAN_CFGID_CURRENT_CHANEL, us_len, puc_param);
        if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
        {
            OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_priv_set_channel::hmac_config_send_event failed[%d].}", ul_ret);
            return ul_ret;
        }
    }
...
oal_int32  hmac_config_get_sta_rssi(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_mac_addr, oal_uint8 *puc_param)
{
    ...
    /* 获取用户对应的索引 */
    pst_hmac_user = mac_vap_get_hmac_user_by_addr(pst_mac_vap, puc_mac_addr);
    ...
    hmac_config_query_rssi(pst_mac_vap , (oal_uint16)OAL_SIZEOF(st_query_rssi_param), (oal_uint8 *)&st_query_rssi_param);
    /*lint -e730*/
...
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_KO_VERSION, OAL_SIZEOF(oal_uint8), puc_param);
}


oal_uint32  hmac_config_get_bcast_rate(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_BCAST_RATE, OAL_SIZEOF(oal_uint8), puc_param);
}
...
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_PWR_REF, OAL_SIZEOF(oal_uint8), puc_param);
}
...
oal_int32  hmac_config_get_neighb_info(mac_vap_stru *pst_mac_vap, oal_ap_scan_result_stru *puc_param)
{
    ...
    OAL_DLIST_SEARCH_FOR_EACH(pst_entry, pst_bss_list_head)
    {
        ...
        hmac_sta_get_user_protocol(pst_bss_dscr, (wlan_protocol_enum_uint8*)(&(st_ap_info.en_protocol)));
...
oal_int32  hmac_config_get_hw_flow_stat(mac_vap_stru *pst_mac_vap, oal_machw_flow_stat_stru *puc_param)
{
    ...
    ***************************************************************************/
    ...
    pst_hmac_vap->station_info_query_completed_flag = OAL_FALSE;
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_HW_FLOW_STAT, OAL_SIZEOF(oal_machw_flow_stat_stru), (oal_uint8*)puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_hw_stat::hmac_config_send_event failed[%d].}", ul_ret);
        return OAL_EFAIL;
    }
    /*lint -e730*/
    l_ret = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q, OAL_TRUE == pst_hmac_vap->station_info_query_completed_flag, (5*OAL_TIME_HZ));
...
oal_int32  hmac_config_get_wme_stat(mac_vap_stru *pst_mac_vap, oal_wme_stat_stru *puc_param)
{
    ...
    ***************************************************************************/
    ...
    pst_hmac_vap->station_info_query_completed_flag = OAL_FALSE;
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_WME_STAT, OAL_SIZEOF(oal_wme_stat_stru), (oal_uint8*)puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_wme_stat::hmac_config_send_event failed[%d].}", ul_ret);
        return OAL_EFAIL;
    }
    /*lint -e730*/
    l_ret = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q, OAL_TRUE == pst_hmac_vap->station_info_query_completed_flag, (5*OAL_TIME_HZ));
...
{
#if defined _PRE_WLAN_PRODUCT_1151V200 && defined _PRE_WLAN_RX_DSCR_TRAILER
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_ANT_RSSI, OAL_SIZEOF(oal_uint8), puc_param);
#else
...
oal_uint32  hmac_config_ant_rssi_report(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_ANT_RSSI_REPORT, us_len,  puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_ant_rssi_report::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_int32  hmac_config_get_tx_delay_ac(mac_vap_stru *pst_mac_vap, oal_tx_delay_ac_stru *puc_param)
{
    ...
    ***************************************************************************/
    ...
    pst_hmac_vap->station_info_query_completed_flag = OAL_FALSE;
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_TX_DELAY_AC, OAL_SIZEOF(oal_tx_delay_ac_stru), (oal_uint8*)puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_tx_delay_ac::hmac_config_send_event failed[%d].}", ul_ret);
        return OAL_EFAIL;
    }
    /*lint -e730*/
    l_ret = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q, OAL_TRUE == pst_hmac_vap->station_info_query_completed_flag, (5*OAL_TIME_HZ));
...
oal_uint32  hmac_config_set_max_user(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint32 ul_max_user)
{
    ...
    {
        OAM_ERROR_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_max_user:: AP/GO want to set the max_user_value[%d] more than the threshold[%d]!}\r\n",
    ...
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_max_user::chip us_user_num_max[%d], us_user_nums_max[%d].}", mac_chip_get_max_asoc_user(pst_mac_vap->uc_chip_id), mac_mib_get_MaxAssocUserNums(pst_mac_vap));
...
oal_uint32  hmac_config_set_dtimperiod(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_mac_device)
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SCAN, "{hmac_config_set_dtimperiod::mac_res_get_dev fail.device_id = %u}",
                           pst_mac_vap->uc_device_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
    {
        ...
        if (OAL_PTR_NULL == pst_vap)
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SCAN, "{hmac_config_set_dtimperiod::pst_mac_vap(%d) null.}",
                           pst_mac_device->auc_vap_id[uc_vap_idx]);
            continue;
        }
        /* 设置mib值 */
        mac_mib_set_dtim_period(pst_vap, (oal_uint8)us_len, puc_param);
    }
#else
    /* 设置mib值 */
...
oal_uint32  hmac_config_set_txpower(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_mac_device))
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_txpower::pst_dev null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
    {
        ...
        if (OAL_PTR_NULL == pst_vap)
        {
            OAM_ERROR_LOG1(0, OAM_SF_CFG, "{hmac_config_set_txpower::pst_ap(%d) null.}",
                pst_mac_device->auc_vap_id[uc_vap_idx]);
            continue;
        }
        mac_vap_set_tx_power(pst_vap, uc_value);
    }
#else
...
#if defined(_PRE_SUPPORT_ACS) || defined(_PRE_WLAN_FEATURE_DFS) || defined(_PRE_WLAN_FEATURE_20_40_80_COEXIST)
    {
        hmac_device_stru *pst_hmac_dev = hmac_res_get_mac_dev(pst_mac_vap->uc_device_id);
...
oal_uint32  hmac_config_get_cali_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_CALI_INFO, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_cali_info::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_set_vap_smps_mode(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_VAP_SMPS, OAL_SIZEOF(mac_cfg_smps_mode_stru), (oal_uint8 *)&st_smps_mode);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SMPS, "{hmac_config_set_vap_smps_mode::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_get_smps_mode_en(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_SMPS_EN, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_smps_mode_en::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32  hmac_config_set_channel_check_param(mac_vap_stru *pst_mac_vap, mac_cfg_channel_param_stru *pst_prot_param)
{
    ...
    if((WLAN_BAND_CAP_2G == pst_prot_param->en_band) && (WLAN_BAND_WIDTH_20M < pst_prot_param->en_bandwidth) &&
...
oal_uint32  hmac_config_set_mib_by_bw(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_mib_by_bw::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32 hmac_config_set_channel(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    else if (OAL_TRUE == mac_is_dbac_enabled(pst_mac_device))
    {
        ...
        if (WLAN_VAP_MODE_BSS_AP != pst_mac_vap->en_vap_mode)
        {
            OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CHAN, "{hmac_config_set_channel::pst_mac_vap is not ap, vap id=%d, mode=%d.}",
    ...
    ***************************************************************************/
    ...
    if (ul_up_vap_cnt < 2)
    {
        ...
        st_acs_cfg.en_switch_chan = OAL_TRUE;
        st_acs_cfg.en_scan_op = MAC_SCAN_OP_INIT_SCAN;
        hmac_init_scan_try(pst_mac_device, pst_mac_vap, MAC_TRY_INIT_SCAN_SET_CHANNEL, &st_acs_cfg);
    }
#endif
#endif
...
oal_uint32  hmac_config_vap_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /* AP/STA协议模式显示 */
    if ((WLAN_VAP_MODE_BSS_STA == pst_mac_vap->en_vap_mode)&& (NULL != (pst_mac_user = mac_res_get_mac_user(pst_mac_vap->us_assoc_vap_id))))
    {
        ...
        if (OAL_TRUE == mac_mib_get_rsnaactivated(pst_mac_vap))
        {
            if(1 == pst_mac_vap->st_cap_flag.bit_wpa)
            {
                ...
                l_string_tmp_len = OAL_SPRINTF(pc_print_buff + ul_string_len, (OAM_REPORT_MAX_STRING_LEN - ul_string_len - 1), "Privacy Invoked: \nRSNA-WPA \n "
                        ...
                        "%s        %s[%s]          %s[%s]             %s[%s]             %s[%s]\n",
                        hmac_config_ciper2string((oal_uint8)ul_group_suit),
                        hmac_config_ciper2string((oal_uint8)aul_pair_suites[0]),
                        (aul_pair_suites[0] == 0) ? "Actived":"Inactived",
                        hmac_config_ciper2string((oal_uint8)aul_pair_suites[1]),
                        (aul_pair_suites[1] == 0) ? "Actived":"Inactived",
                        hmac_config_akm2string((oal_uint8)aul_akm_suites[0]),
                        (aul_akm_suites[0] == 0) ? "Actived":"Inactived",
                        hmac_config_akm2string((oal_uint8)aul_akm_suites[1]),
...
oal_uint32  hmac_config_protocol_debug_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if(pst_protocol_debug->ul_cmd_bit_map & BIT3)
    {
        ...
        ul_ret = mac_is_channel_num_valid(pst_mac_vap->st_channel.en_band,pst_protocol_debug->st_csa_debug_bit3.uc_channel);
        if(OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_protocol_debug_switch::mac_is_channel_num_valid(%d),return.",
...
oal_uint32  hmac_config_amsdu_ampdu_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_amsdu_ampdu_switch::ENABLE MODE[%d][0:disable,1:enable].}", pst_amsdu_ampdu_cfg->ul_value);
...
oal_uint32  hmac_config_always_tx_hw(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_ALWAYS_TX_HW, us_len, puc_param);
...
oal_uint32  hmac_config_always_tx_51(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
   oal_uint32                       ul_ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_ALWAYS_TX_51, us_len, puc_param);
...
oal_uint32  hmac_config_always_rx_51(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_ALWAYS_RX_51, us_len, puc_param);
...
oal_uint32 hmac_config_dync_pow_debug_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_DYNC_POW_DEBUG, us_len, puc_param);

    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_dync_pow_debug_switch::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_list_sta(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    for (us_user_idx = 0; us_user_idx < MAC_VAP_USER_HASH_MAX_VALUE; us_user_idx++)
    {
        OAL_DLIST_SEARCH_FOR_EACH(pst_head, &(pst_mac_vap->ast_user_hash[us_user_idx]))
        {
            ...
            {
                OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_list_sta:: protocol_mode wrong.}",en_protocol_mode);
                continue;
            }
    ...
    oam_print(pc_print_buff);
#ifdef _PRE_WLAN_FEATURE_USER_EXTEND
    oam_print(pc_print_buff2);
    oam_print(pc_print_buff3);
    oam_print(pc_print_buff4);
#endif
    OAL_MEM_FREE(pc_print_buff, OAL_TRUE);
#ifdef _PRE_WLAN_FEATURE_USER_EXTEND
    OAL_MEM_FREE(pc_print_buff2, OAL_TRUE);
...
oal_uint32  hmac_config_set_country(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_country::country code=%c%c fcc_flag[%d].}",
                     (oal_uint8)pst_mac_regdom->ac_country[0],(oal_uint8)pst_mac_regdom->ac_country[1], pst_mac_regdom->en_fcc_country);
...
oal_uint32  hmac_config_hide_ssid(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG1(0, OAM_SF_CFG, "{dmac_config_hide_ssid::mac_vap_set_hide_ssid [%d].}", uc_hide_ssid);
...
oal_uint32  hmac_config_connect(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
   ...
   if(OAL_TRUE == pst_hmac_vap->bit_11r_enable)
   {
    ...
    /* 获取扫描的bss信息 */
    pst_bss_dscr = (mac_bss_dscr_stru *)hmac_scan_get_scanned_bss_by_bssid(pst_mac_vap, pst_connect_param->puc_bssid);
    ...
    if (oal_memcmp(pst_connect_param->puc_ssid, pst_bss_dscr->ac_ssid, (oal_uint32)pst_connect_param->uc_ssid_len))
    {
    ...
    if (MAC_VAP_STATE_UP == pst_mac_vap->en_vap_state)
    {
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_connect:: roaming AP with ressoc frame, XX:XX:XX:%02X:%02X:%02X}",
                         pst_connect_param->puc_bssid[3], pst_connect_param->puc_bssid[4], pst_connect_param->puc_bssid[5]);
        if (!oal_memcmp(pst_mac_vap->auc_bssid, pst_connect_param->puc_bssid, OAL_MAC_ADDR_LEN)) {
            /* reassociation */
            return hmac_roam_start(pst_hmac_vap, ROAM_SCAN_CHANNEL_ORG_0, OAL_TRUE);
        }
        else /* roaming */
            return hmac_roam_start(pst_hmac_vap, ROAM_SCAN_CHANNEL_ORG_0, OAL_FALSE);
    }
#endif  /* _PRE_WLAN_FEATURE_ROAM */
    ...
    if(OAL_TRUE == pst_hmac_vap->bit_11r_enable)
    {
        ...
        if ((OAL_PTR_NULL != puc_mde) && (WLAN_WITP_AUTH_FT == mac_mib_get_AuthenticationMode(&pst_hmac_vap->st_vap_base_info)))
        {
...
oal_uint32 hmac_config_get_assoc_req_ie(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    *pus_len = OAL_SIZEOF(oal_net_dev_ioctl_data_stru);
    ...
    if(ul_len > pst_assoc_req_ioctl_data->pri_data.assoc_req_ie.ul_buf_size)
    {
        ...
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_assoc_req_ie::user space[%d] not enough,need[%d].}",
                                            ...
                                            en_app_ie_type_uint8 en_type)
{
    ...
    {
        puc_ie = mac_find_ie(pst_hmac_vap->st_remove_ie.uc_eid, pst_app_ie->auc_ie, (oal_int32)pst_app_ie->ul_ie_len);
        if(puc_ie != OAL_PTR_NULL)
        {
            pst_app_ie->ul_ie_len  -= (oal_uint32)(puc_ie[1] + MAC_IE_HDR_LEN);
            remain_len              = pst_app_ie->ul_ie_len - (oal_uint32)(puc_ie - pst_app_ie->auc_ie);
...
oal_uint32  hmac_config_dfs_radartool(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    else if (0 == oal_strcmp(pc_token, "get_cac"))
    {
        ...
        if (0 == oal_strcmp(pc_token, "weather"))
        {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_DFS, "hmac_config_dfs_radartool::get_cac(weather radar)=%d.",ul_val);
        ...
        else if (0 == oal_strcmp(pc_token, "nonweather"))
        {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_DFS, "hmac_config_dfs_radartool::get_cac(nonweather radar)=%d.",ul_val);
    ...
    else if(0 == oal_strcmp(pc_token, "set_next_chan"))
    {
        ...
        {
            OAM_WARNING_LOG0(0, OAM_SF_DFS, "hmac_config_dfs_radartool::next chan should be a valid channel.");
            return OAL_ERR_CODE_INVALID_CONFIG;
        }
    ...
    else if(0 == oal_strcmp(pc_token, "get_next_chan"))
    {
        ...
        if(ul_val)
        {
            OAM_WARNING_LOG1(0, OAM_SF_DFS, "hmac_config_dfs_radartool::get_next_chan=%d.",ul_val);

            OAL_IO_PRINT("next radar ch = %d(%s)\r\n",ul_val, mac_vap_width_to_str(en_width));
        }
        else
        {
            OAM_WARNING_LOG0(0, OAM_SF_DFS, "hmac_config_dfs_radartool::get_next_chan=random.");
    ...
    else if(0 == oal_strcmp(pc_token, "set_5g_channel_bitmap"))
    {
        ...
        if(0 == ul_val)
        {
            OAM_WARNING_LOG0(0, OAM_SF_DFS, "hmac_config_dfs_radartool::5G channel bitmap should not be zero.");
            return OAL_ERR_CODE_INVALID_CONFIG;
        }

        OAM_WARNING_LOG1(0, OAM_SF_DFS, "hmac_config_dfs_radartool::set 5G channel bitmap 0x%x.",ul_val);
    ...
    else if(0 == oal_strcmp(pc_token, "get_5g_channel_bitmap"))
    {
        ...
        if(ul_val)
        {
            OAM_WARNING_LOG1(0, OAM_SF_DFS, "hmac_config_dfs_radartool::get_5G_channel_bitmap=0x%x.",ul_val);

            OAL_IO_PRINT("custom 5G channel bitmap = 0x%x\r\n",ul_val);
        }
        else
        {
            OAM_WARNING_LOG0(0, OAM_SF_DFS, "hmac_config_dfs_radartool::custom 5G channel bitmap not set.");
...
oal_uint32  hmac_config_acs(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    else if (0 == oal_strcmp(pc_token, "fscan"))
    {
        ...
        hmac_init_scan_process(pst_hmac_device, pst_mac_vap, &st_acs_cfg);
    }
...
oal_uint32 hmac_do_chan_stat(hmac_device_stru *pst_hmac_dev, mac_vap_stru *pst_mac_vap, mac_chan_stat_param_stru *pst_param)
{
    ...
    for (uc_idx = 0; uc_idx < pst_param->uc_chan_cnt; uc_idx++)
    {
        ...
        if (OAL_SUCC != mac_is_channel_num_valid(en_band, uc_channel))
        {
            continue;
        }
        ...
        if(OAL_SUCC != mac_get_channel_idx_from_num(en_band, uc_channel, &st_scan_req.ast_channel_list[uc_cnt].uc_chan_idx))
        {
            continue;
        }
        uc_cnt++;
    ...
    if (uc_cnt != 0)
    {
        ...
        /* 直接调用扫描模块扫描请求处理函数 */
        ul_ret = hmac_scan_proc_scan_req_event(OAL_DLIST_GET_ENTRY(pst_mac_vap, hmac_vap_stru, st_vap_base_info), &st_scan_req);
        if(OAL_SUCC != ul_ret)
        {
...
oal_uint32  hmac_config_bsd(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_BSD_CONFIG, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_bsd::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_get_bsd(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_BSD, OAL_SIZEOF(mac_cfg_query_bsd_stru), (oal_uint8 *)&st_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_bsd::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_11v_ap_tx_request(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_11V_TX_REQUEST, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_11v_ap_tx_request::hmac_config_send_event failed[%d].}", ul_ret);
    }
    return OAL_SUCC;
}
...
oal_uint32  hmac_config_alg(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
#ifdef _PRE_WLAN_FEATURE_DBAC
    {
          ...
          && !oal_strcmp((const oal_int8 *)puc_param + OAL_SIZEOF(mac_ioctl_alg_config_stru), " dbac start"))
        {
            ...
            st_acs_cfg.en_switch_chan = OAL_TRUE;
            st_acs_cfg.en_scan_op = MAC_SCAN_OP_INIT_SCAN;
            if(OAL_SUCC == hmac_init_scan_try(pst_mac_device, pst_mac_vap, MAC_TRY_INIT_SCAN_START_DBAC, &st_acs_cfg))
            {
                return OAL_SUCC;
            }
        }
...
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_FAST_AGING, us_len, puc_param);
}
oal_uint32 hmac_config_get_fast_aging(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_FAST_AGING, OAL_SIZEOF(oal_uint8), puc_param);
}
...
oal_uint32  hmac_config_waveapp_32plus_user_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_WAVEAPP_32PLUS_USER_ENABLE, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_waveapp_32plus_user_enable::hmac_config_send_event failed[%d].}", ul_ret);
    }
    return ul_ret;
}
#endif
...
oal_uint32  hmac_config_rssi_limit(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_RSSI_LIMIT_CFG, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_pcie_test::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_80m_rts_debug(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_80M_RTS_DEBUG, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_80m_rts_debug::hmac_config_send_event failed[%d].}", ul_ret);
    }
    return ul_ret;
}
#endif
...
oal_uint32  hmac_config_set_auto_protection(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    oal_uint32                       ul_ret = 0;
...
oal_uint32 hmac_config_ch_status_sync(mac_device_stru *pst_mac_dev)
{
    ...
    /***************************************************************************
        抛事件到DMAC层
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SYNC_CH_STATUS, OAL_SIZEOF(ast_ap_channel_list), (oal_uint8 *)ast_ap_channel_list);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
...
oal_uint32 hmac_config_get_cali_data(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_CALI_DATA, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_cali_data:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_get_smps_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    for (uc_vap_index = 0; uc_vap_index < pst_mac_device->uc_vap_num; uc_vap_index++)
    {
        ...
        OAL_SPRINTF(ac_tmp_buff, OAL_SIZEOF(ac_tmp_buff), "VAP Index[%d] SMPS CAP IS [%s]; SMPS MODE IS [%s]!\r\n",
                    ...
                    hmac_config_smps2string(mac_vap_get_smps_mode(pst_mac_vap) - 1),
...
oal_uint32  hmac_config_set_opmode_notify(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{hmac_config_set_opmode_notify::pst_mac_vap is not 11ac. en_protocol = [%d].}\r\n", pst_mac_vap->en_protocol);
        return OAL_FAIL;
    }
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_OPMODE_NOTIFY, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{hmac_config_set_opmode_notify::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
#endif
...
oal_uint32  hmac_config_get_temp(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_TEMP, *pus_len, puc_param);

    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_temp::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_query_drop_num(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_QUERY_DROP_NUM, us_len, puc_param);
...
oal_uint32  hmac_config_query_tx_delay(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_QUERY_TX_DELAY, us_len, puc_param);
...
extern oal_uint16                      g_us_efuse_buffer[32];
...
OAL_STATIC oal_uint32  hmac_config_d2h_vap_cap_update(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                        "{hmac_config_d2h_vap_cap_update::en_1024_cap=[%d], en_nb_cap=[%d].}",
...
oal_uint32  hmac_config_user_m2s_info_syn(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    /* 同步用户空间流 */
    mac_user_set_num_spatial_stream(pst_mac_user, pst_syn_info->en_user_num_spatial_stream);
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_M2S,
                  "{hmac_config_user_m2s_info_syn::en_avail_bandwidth[%d],bf_num_spatial_stream[%d]avail_num_spatial_stream[%d],smps_mode[%d]!}",
                    pst_mac_user->en_avail_bandwidth, pst_mac_user->en_avail_bf_num_spatial_stream,
...
oal_uint32  hmac_config_vap_m2s_info_syn(mac_vap_stru *pst_mac_vap)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步VAP最新状态到DMAC
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_VAP_M2S_INFO_SYN, OAL_SIZEOF(mac_vap_m2s_stru), (oal_uint8 *)(&st_m2s_vap_info));
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
...
oal_uint32 hmac_config_d2h_vap_m2s_info_syn(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    if(WLAN_M2S_TYPE_HW == pst_syn_info->en_m2s_type)
    {
        ...
        /*1. 踢掉该vap的用户 */
        ul_ret = hmac_config_kick_user(pst_mac_vap, OAL_SIZEOF(oal_uint32), (oal_uint8 *)&st_kick_user_param);
        if(OAL_SUCC != ul_ret)
        {
...
oal_void  hmac_set_device_freq_mode(oal_uint8 uc_device_enable)
{
...
oal_uint32 hmac_config_roam_start(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    return hmac_roam_start(pst_hmac_vap, (roam_channel_org_enum)pst_roam_start->uc_scan_type, pst_roam_start->en_current_bss_ignore);
}
...
oal_uint32  hmac_config_get_waveapp_flag(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_WAVEAPP_FLAG, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_waveapp_flag::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_cali_power(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_CALI_POWER, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
...
oal_uint32  hmac_config_get_cali_power(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_CALI_POWER, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_cali_power:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_set_polynomial_param(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_POLYNOMIAL_PARA, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_polynomial_param:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_get_upc_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_UPC_PARA, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_get_upc_params:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_set_upc_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_UPC_PARA, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_upc_params:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_set_load_mode(mac_vap_stru *pst_mac_vap,oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_LOAD_MODE, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_load_mode:hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_set_2g_txrx_path(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 配置DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_2G_TXRX_PATH, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_set_2g_txrx_path::hmac_config_send_event fail[%d].", ul_ret);
    }
...
oal_uint32  hmac_config_load_ini_power_gain(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_LOAD_INI_PWR_GAIN, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_load_ini_power_gain::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_set_white_lst_ssidhiden(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
     抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_WHITE_LIST_SSIDHIDEN, OAL_SIZEOF(oal_hilink_white_node_stru), puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG2(0, OAM_SF_CFG, "{hmac_config_set_white_lst_ssidhiden::hmac_config_send_event failed[%d], vap id[%d].}", ul_ret, pst_mac_vap->uc_vap_id);
    }
#endif
...
oal_uint32 hmac_config_set_sta_bcn_request(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /*获取用户*/
    pst_mac_user = mac_vap_get_user_by_addr(pst_mac_vap, pst_sta_neighbor_bcn_req->pri_data.fbt_11k_sta_neighbor_bcn_req.auc_sta_mac);
    if (OAL_PTR_NULL == pst_mac_user)
    {
...
oal_uint32 hmac_config_change_to_other_ap(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_HILINK, "{hmac_config_change_to_other_ap::hmac_config_send_event failed[%d].}", ul_ret);
    }
    return ul_ret;
#else
...
oal_uint32  hmac_config_fbt_scan_list_clear(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_HILINK, "{hmac_config_fbt_scan_list_clear::hmac_config_send_event failed[%d].}", ul_ret);
    }
#endif
    return ul_ret;
...
oal_uint32  hmac_config_fbt_scan_specified_sta(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_HILINK, "{hmac_config_fbt_scan_specified_sta::hmac_config_send_event failed[%d].}", ul_ret);
    }
#endif
...
oal_uint32  hmac_config_fbt_scan_channel(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_ERROR_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_HILINK, "{hmac_config_fbt_scan_channel::mac_is_channel_num_valid failed.[channel:%d][band:%d][ret:%d].}", uc_fbt_scan_channel,pst_mac_vap->st_channel.en_band, ul_ret);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
...
oal_uint32 hmac_config_set_mgmt_frame_filters(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_MGMT_FRAME_FILTERS, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
...
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_STA_DIAG_INFO, us_len, puc_param);
}

oal_uint32 hmac_config_get_vap_diag_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_VAP_DIAG_INFO, us_len, puc_param);
}
...
oal_uint32 hmac_config_set_sensing_bssid(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
     抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_SENSING_BSSID, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG2(0, OAM_SF_HILINK, "{hmac_config_set_sensing_bssid::hmac_config_send_event failed[%d], vap id[%d].}", ul_ret, pst_mac_vap->uc_vap_id);
    }
...
{
    return hmac_config_send_event(pst_mac_vap, WLAN_CFGID_GET_SENSING_BSSID_INFO, us_len, puc_param);
}
...
oal_uint32 hmac_config_send_action_frame(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /* 获取用户 */
    pst_hmac_user = mac_vap_get_hmac_user_by_addr(pst_mac_vap, pst_frame_msg->auc_mac_addr);
    if (OAL_PTR_NULL == pst_hmac_user)
    {
    ...
    ul_ret = hmac_tx_mgmt_send_event(pst_mac_vap, pst_netbuf_mgmt_tx, (oal_uint16)pst_frame_msg->us_len);
    if (OAL_SUCC != ul_ret)
    {
        oal_netbuf_free(pst_netbuf_mgmt_tx);
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_HILINK, "{hmac_config_send_action_frame::hmac_tx_mgmt_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_set_tx_classify_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "hmac_config_set_tx_classify_switch::change nothing to flag:%d", mac_mib_get_TxTrafficClassifyFlag(pst_mac_vap));
        return OAL_SUCC;
    }
...
oal_uint32  hmac_config_voe_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    en_read_flag = (((*puc_param) & 0x1F) & BIT4) ? OAL_TRUE : OAL_FALSE;
    ...
    else
    {
        ...
        pst_hmac_vap->bit_rrm_include_enable = (((*puc_param) & 0x0F) & BIT3) ? OAL_TRUE : OAL_FALSE;
    #endif
    }
...
oal_uint32  hmac_config_send_radio_meas_req(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /*获取用户*/
    pst_mac_user = mac_vap_get_user_by_addr(pst_mac_vap, pst_radio_meas_cfg->auc_mac_addr);
    if (OAL_PTR_NULL == pst_mac_user)
    {
...
oal_uint32  hmac_config_packet_capture_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_PACKET_CAPTURE_SWITCH, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_packet_capture_switch::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_user_extend_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_USER_EXTEND_ENABLE, us_len, puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_user_extend_enable::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_query_stat_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_QUERY_STAT_INFO, us_len, puc_param);

    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_query_stat_info::hmac_config_send_event failed[%d].}", ul_ret);
    }
