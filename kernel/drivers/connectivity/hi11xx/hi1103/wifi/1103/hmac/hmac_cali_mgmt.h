...
#define HI1103_DPD_OFFLINE_CALI_BW_NUM (1)
#define HI1103_2G_DPD_CALI_CHANNEL_NUM (5)

#define HI1103_DPD_TPC_LEVEL_NUM (3)
#define HI1103_DPD_CALI_LUT_LENGTH (31)

#define HI1103_DPD_OFFLINE_CALI_LUT_NUM (HI1103_2G_DPD_CALI_CHANNEL_NUM * HI1103_DPD_TPC_LEVEL_NUM * HI1103_DPD_OFFLINE_CALI_BW_NUM)
...
#define HI1103_CALI_MATRIX_DATA_NUMS       (8)
