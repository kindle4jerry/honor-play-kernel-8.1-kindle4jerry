...
typedef enum
{
    HAL_DEV_RSSI_SWITCH_EN     =0,
    HAL_DEV_SNR_SWITCH_EN      =HAL_DEV_RSSI_SWITCH_EN,
    HAL_DEV_RSSI_HIGH_TH       =1,
    HAL_DEV_SNR_HIGH_TH        =HAL_DEV_RSSI_HIGH_TH,
    HAL_DEV_RSSI_LOW_TH        =2,
    HAL_DEV_SNR_LOW_TH         =HAL_DEV_RSSI_LOW_TH,
    HAL_DEV_RSSI_HIGH_TH_CNT   =3,
    HAL_DEV_SNR_HIGH_TH_CNT    =HAL_DEV_RSSI_HIGH_TH_CNT,
    HAL_DEV_RSSI_LOW_TH_CNT    =4,
    HAL_DEV_SNR_LOW_TH_CNT     =HAL_DEV_RSSI_LOW_TH_CNT,
    HAL_DEV_RSSI_LOG_PRINT     =5,
    HAL_DEV_SNR_LOG_PRINT     =HAL_DEV_RSSI_LOG_PRINT,
}hal_dev_rssi_enum;
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            mac_m2s_command_mode_enum_uint8  uc_m2s_mss_mode;
        }mss_mode;
...
typedef struct
{
    ...
    oal_uint8                uc_cfg_btcoex_type;     /* 0:门限类型; 1:聚合大小类型 */
...
typedef struct
{
    oal_uint8                uc_cfg_preempt_mode;     /* 0:硬件preempt; 1:软件preempt */
...
extern oal_uint32  mac_chip_init(mac_chip_stru *pst_chip, oal_uint8 uc_device_max);
extern oal_uint32  mac_board_init(void);
