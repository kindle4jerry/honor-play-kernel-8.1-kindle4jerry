...
#define MAC_MAX_RATE_SINGLE_NSS_160M_11AC 866 /* 1个空间流160MHz的最大速率*/
...
#define MAC_MAX_RATE_DOUBLE_NSS_160M_11AC 1735 /* 2个空间流160MHz的最大速率*/
#endif
...
#define CUS_DY_CALI_DPN_PARAMS_NUM          4   /* 定制化动态校准2.4G DPN参数个数11b OFDM20/40 CW */
#endif
...
typedef enum
{
    ...
    /*发送端接收端平衡算法配置参数*/
    MAC_ALG_CFG_RX_TX_BALANCE_CTL_ENABLE,
    MAC_ALG_CFG_RX_TX_BALANCE_CTL_LOG_DEBUG,
    MAC_ALG_CFG_RX_TX_BALANCE_CTL_RESTORE_THRESHOLD_ADJUST,
    MAC_ALG_CFG_RX_TX_BALANCE_CTL_RESTORE_NUM_ADJUST,

    /*多device接收端描述符分配算法配置参数*/
    MAC_ALG_CFG_RX_DSCR_CTL_START,
    MAC_ALG_CFG_RX_DSCR_CTL_ENABLE,
    MAC_ALG_CFG_RX_DSCR_CTL_TIMEOUT,
    MAC_ALG_CFG_RX_DSCR_CTL_NORM_MAX,
    MAC_ALG_CFG_RX_DSCR_CTL_NORM_MIN,
    MAC_ALG_CFG_RX_DSCR_CTL_SMALL_MAX,
    MAC_ALG_CFG_RX_DSCR_CTL_SMALL_MIN,
...
typedef struct
{
    oal_int8   c_cfg_delta_pwr_ref_rssi_2g[WLAN_RF_CHANNEL_NUMS];
    oal_int8   c_cfg_delta_pwr_ref_rssi_5g[WLAN_RF_CHANNEL_NUMS];
...
{
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
    mac_cfg_custom_gain_db_stru ast_rf_gain_db_rf[WLAN_RF_CHANNEL_NUMS];          /* rf0 rf1 */
    mac_cfg_custom_ext_rf_stru  ast_ext_rf[WLAN_BAND_BUTT][WLAN_RF_CHANNEL_NUMS]; /* 2.4g 5g */
    mac_cfg_custom_delta_pwr_ref_stru  st_delta_pwr_ref_cfg; /* ast_rf_gain_db_rf计算溢出时的额外pwr ref增益值 */
#else
...
typedef struct
{
    oal_int16 as_dy_cali_base_ratio_params[CUS_DY_CALI_PARAMS_NUM][CUS_DY_CALI_PARAMS_TIMES];    /* 产测定制化参数数组 */
    oal_int8  ac_dy_cali_dpn_params[MAC_2G_CHANNEL_NUM][CUS_DY_CALI_DPN_PARAMS_NUM];
#ifdef _PRE_WLAN_DPINIT_CALI
...
{
    /* 定制化是否打开ddc动态调整开关 */
    oal_uint8    uc_ini_ddc_en;
    /* 当前聚合是否为amsdu聚合 */
    oal_uint8    uc_cur_ddc_status;
    oal_uint16   us_ddc_rx_throughput_high;
    oal_uint16   us_ddc_rx_throughput_low;
    oal_uint16   us_resv;
}mac_rx_ddc_switch_stru;
extern mac_rx_ddc_switch_stru g_st_rx_ddc_switch;
...
extern oal_void  mac_vap_change_mib_by_bandwidth(mac_vap_stru *pst_mac_vap, wlan_channel_band_enum_uint8 en_band, wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_void mac_vap_set_assoc_id(mac_vap_stru *pst_vap, oal_uint16 us_assoc_vap_id);
...
extern oal_void mac_vap_set_rx_nss(mac_vap_stru *pst_vap, wlan_nss_enum_uint8 en_rx_nss);
extern oal_uint32 mac_vap_init_privacy(mac_vap_stru  *pst_mac_vap, mac_conn_security_stru *pst_conn_sec);
extern oal_uint32 mac_mib_set_wep(mac_vap_stru *pst_mac_vap, oal_uint8 uc_key_id, oal_uint8 uc_key_value);
...
#endif
extern oal_void  mac_init_mib(mac_vap_stru *pst_mac_vap);
extern oal_void mac_vap_free_mib(mac_vap_stru  *pst_vap);
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
