...
*****************************************************************************/
/* 作为P2P GO 允许关联最大用户数 */
#define WLAN_P2P_GO_ASSOC_USER_MAX_NUM_SPEC 8
...
#define HAL_NORMAL_CONTIUS_IRQ_THRES       3
...
#define PPS_VALUE_1              (4000)       /*40M up limit*/
#define PPS_VALUE_2              (8000)      /*80M up limit*/
