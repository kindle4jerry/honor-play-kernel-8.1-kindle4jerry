...
#endif
#define MAC_HE_OPERAION_MIN_LEN             8
#endif
...
{
    oal_uint8           bit_htc_he_support                                     : 1,/* 指示站点是否支持接收Qos Data、Qos Null、管理帧携带 HE 变体的HT Control field*/
                        bit_twt_requester_support                              : 1,/* 是否支持TWT Requester */
                        bit_twt_responder_support                              : 1,/* 是否支持TWT Responder*/
                        bit_fragmentation_support                              : 2,/* 动态分片能力*/
                        bit_msdu_max_fragment_num                              : 3;/*msdu最大分片数 */

    oal_uint16          bit_min_fragment_size                                  : 2,/* 最小分片的长度*/
                        bit_trigger_mac_padding_duration                       : 2,/*trigger mac padding 时长*/
                        bit_mtid_aggregation_rx_support                        : 3,/* 接收多tid聚合支持*/
                        bit_he_link_adaptation                                 : 2,/*使用HE 变体的HT Control field 调整*/
                        bit_all_ack_support                                    : 1,/*支持接收M-BA*/
                        bit_umrs_support                                       : 1,/*A-Control 支持 UL MU Response Scheduling*/
                        bit_bsr_support                                        : 1,/*A-Control 支持BSR*/
                        bit_broadcast_twt_support                              : 1,/*支持广播twt*/
                        bit_32bit_ba_bitmap_support                            : 1,/*支持32位bitmap ba*/
                        bit_mu_cascade_support                                 : 1,/*mu csacade*/
                        bit_ack_enabled_aggregation_support                    : 1;/*A-MPDU ack使能*/

    oal_uint8           bit_group_addressed_msta_ba_dl_mu_support              : 1,/*B24-*/
                        bit_om_control_support                                 : 1,/*A-Control 支持OMI  */
                        bit_ofdma_ra_support                                   : 1,/*OFDMA 随机接入*/
                        bit_max_ampdu_length_exponent                          : 2,/*A-MPDU最大长度*/
                        bit_amsdu_fragment_support                             : 1,
                        bit_flex_twt_schedule_support                          : 1,
...
{
#ifdef _PRE_WLAN_FEATURE_11AX_BELOW_DRAFT22
    oal_uint8           bit_dual_band_support                                  : 1,/*  */
#else
    oal_uint8           bit_reserved                                           : 1,/*  */
#endif
                        bit_channel_width_set                                  : 7;/* */

    oal_uint16          bit_punctured_preamble_rx                              : 4,/*B8-*/
                        bit_device_class                                       : 1,/**/
                        bit_ldpc_coding_in_paylod                              : 1,/* */
                        bit_he_su_ppdu_1x_ltf                                  : 1,/*1x HE-LTF + 0.8usGI  */
                        bit_midamble_rx_max_nsts                               : 2,/**/
                        bit_ndp_4x                                             : 1,/*B17-ndp 4x HE-LTF + 3.2usGI*/
                        bit_stbc_tx_below_80mhz                                : 1,/**/
                        bit_stbc_rx_below_80mhz                                : 1,/**/
                        bit_dopper_tx                                          : 1,/**/
                        bit_droper_rx                                          : 1,/**/
                        bit_full_bandwidth_ul_mu_mimo                          : 1,/**/
                        bit_partial_bandwidth_ul_mu_mimo                       : 1;

    oal_uint8           bit_dcm_mac_constellation_tx                           : 2,/*B24-*/
                        bit_dcm_max_nss_tx                                     : 1,/**/
                        bit_dcm_max_constellation_rx                           : 2,/**/
                        bit_dcm_max_nss_rx                                     : 1,
                        bit_ul_he_mu_ppdu_support                              : 1,/**/
                        bit_su_beamformer                                      : 1;

    oal_uint8           bit_su_beamformee                                      : 1,/*B32-*/
                        bit_mu_beamformer                                      : 1,
                        bit_beamformee_sts_below_80mhz                         : 3,
                        bit_beamformee_sts_over_80mhz                          : 3;

    oal_uint8           bit_over_80mhz_sounding_dimensions_num                 : 3,/*B40- */
                        bit_below_80mhz_sounding_dimensions_num                : 3,
                        bit_ng16_su_feedback                                   : 1,
                        bit_ng16_mu_feedback                                   : 1;

    oal_uint8           bit_codebook_42_feedback                               : 1,/*B48-*/
                        bit_codebook_75_feedback                               : 1,
                        bit_trigger_su_beamform_feedback                       : 1,
                        bit_trigger_mu_beamform_feedback                       : 1,
                        bit_trigger_cqi_feedback                               : 1,
                        bit_partial_bandwidth_extended_range                   : 1,
                        bit_partial_bandwidth_dl_mu_mimo                       : 1,
                        bit_ppe_threshold_present                              : 1;

    oal_uint8           bit_srp_based_sr_support                               : 1,/*B56-*/
                        bit_power_boost_factor_support                         : 1,
                        bit_4x_he_ltf_8us_gi                                   : 1,/* 4x HE-LTF + 0.8usGI*/
                        bit_max_nc                                             : 3,
                        bit_stbc_tx_over_80mhz                                 : 1,
                        bit_stbc_rx_over_80mhz                                 : 1;

    oal_uint8           bit_he_er_su_ppdu_4x_ltf                               : 1,/*B64-*/
                        bit_20mhz_in_40mhz_he_ppdu_2g                          : 1,
                        bit_20mhz_in_160mhz_he_ppdu                            : 1,
                        bit_80mhz_in_160mhz_he_ppdu                            : 1,
                        bit_he_er_su_ppdu_1x_ltf                               : 1,
                        bit_midamble_rx_2x_1x_he_ltf                           : 1,
                        bit_reserved2                                          : 2;
}__OAL_DECLARE_PACKED;
...
#ifdef _PRE_WLAN_FEATURE_11AX_BELOW_DRAFT22
typedef struct mac_frame_he_operation_param_stru mac_frame_he_operation_format_stru;
#else
...
extern oal_void  mac_set_dsss_params(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint8 uc_channel_num);
...
extern oal_void mac_set_rsn_ie(oal_void *pv_mac_vap, oal_uint8 *puc_pmkid, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
extern oal_void mac_set_wpa_ie(oal_void *pst_mac_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
...
#ifdef _PRE_WLAN_FEATURE_OPMODE_NOTIFY
extern oal_void mac_set_opmode_field(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, wlan_nss_enum_uint8 en_nss);
extern oal_void mac_set_opmode_notify_ie(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
#endif
