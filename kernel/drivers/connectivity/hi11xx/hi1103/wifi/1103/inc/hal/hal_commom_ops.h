...
#define HAL_NUM_5G_40M_SIDE_BAND                 4
#define HAL_NUM_5G_80M_SIDE_BAND                 4
...
#define HAL_POW_LPF_BASE_IDX                2           /* 基准LPF Index */
#define HAL_POW_DAC_BASE_IDX                0           /* 基准DAC Index */
#ifdef _PRE_WLAN_1103_PILOT
...
#define HAL_POW_ADJUST_LEVEL_NUM        4           /*算法支持可调整的档位数目*/
...
#define HAL_INI_POW_CODE    (HAL_POW_CODE_COMB(OAL_TRUE, HAL_POW_UPC_LOW_START_IDX, HAL_POW_PA_BASE_IDX, HAL_POW_DAC_BASE_IDX,  \
                                               HAL_POW_LPF_BASE_IDX, HAL_POW_DELTA_DBB_SCAL_BASE_IDX, HAL_POW_DPD_TPC_BASE_IDX, \
...
#define HAL_INI_POW_CODE    (HAL_POW_CODE_COMB(HAL_POW_UPC_LOW_START_IDX, HAL_POW_LPF_BASE_IDX, HAL_POW_PA_BASE_IDX, \
                                            HAL_POW_DAC_BASE_IDX, HAL_POW_DBB_SCAL2_C0_BASE_IDX, HAL_POW_DBB_SCAL2_C1_BASE_IDX))
...
#define GET_DEV_RX_DSCR_ISR_INFO_CNT(_pst_hal_dev, _uc_queue_id) \
    (((alg_rx_dscr_ctl_alg_info_stru *)((_pst_hal_dev)->st_rx_dscr_ctl.pst_rx_dscr_ctl_alg_info + (_uc_queue_id)))->uc_pending_isr_info_cnt)
#define GET_DEV_RX_DSCR_ISR_PKTS_NUM(_pst_hal_dev, _uc_queue_id) \
    (((alg_rx_dscr_ctl_alg_info_stru *)((_pst_hal_dev)->st_rx_dscr_ctl.pst_rx_dscr_ctl_alg_info + (_uc_queue_id)))->uc_pending_isr_pkts_num)
...
/* 获取各速率最大发送功率 */
#define HAL_DEV_GET_PER_RATE_MAX_POW_CTRL(_pst_hal_dev, _uc_rate_idx, _en_freq_band) \
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_reserv[1];
...
typedef struct
{
    ...
    /*不同帧的tpc code*/
#if ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST))
    oal_uint32                      aul_2g_24_ofdm_ack_cts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_36_ofdm_ack_cts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_48_ofdm_ack_cts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_54_ofdm_ack_cts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_24_ack_cts_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_36_ack_cts_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_48_ack_cts_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_54_ack_cts_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_dsss_ack_cts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_rts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_one_pkt_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_resv1[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_resv2[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_resv3[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_cfend_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_rts_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_one_pkt_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_resv4[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_cfend_pow_code[WLAN_5G_SUB_BAND_NUM];
...
#ifdef _PRE_WLAN_1103_PILOT
    oal_uint16                             aus_resv[NUM_OF_NV_MAX_TXPOWER];
#else
    /* 2) DBB_SCALING@rate */
...
typedef struct
{
    ...
    oal_uint8                       uc_pending_isr_info_cnt;      /* 记录pinding在乒乓队列里的isr info数量 */
    oal_uint8                       uc_pending_isr_pkts_num;      /* 记录pinding在乒乓队列里的帧数量 */
...
typedef struct
{
    ...
    oal_uint32                      ul_rx_norm_comp_mpdu_num;     /* device周期内接收完成包个数 */
    oal_uint32                      ul_rx_small_comp_mpdu_num;    /* device周期内接收完成包个数 */
    oal_uint16                      us_rx_norm_dscr_cnt;          /* 小包队列补满长度 */
    oal_uint16                      us_rx_small_dscr_cnt;         /* 普通优先级队列补满长度 */
...
typedef struct tag_hal_to_dmac_device_stru
{
    ...
    oal_int8                       auc_recv2[2];
#else
    oal_int8                       auc_recv2[3];
#endif
...
typedef struct
{
    oal_uint32 ul_phy_err_rpt;
    oal_uint32 ul_rx_desc_status;
    oal_uint32 ul_rx_desc_rssi;
    oal_uint32 ul_rpt_snr_ant1;
    oal_uint32 ul_rpt_snr_ant0;
    oal_uint32 ul_rpt_aver_evm_ant1;
    oal_uint32 ul_rpt_aver_evm_ant0;
    oal_uint32 ul_rpt_max_evm_ant1;
    oal_uint32 ul_rpt_max_evm_ant0;
    oal_uint32 ul_dotb_err_frm_num;
    oal_uint32 ul_ht_err_frm_num;
    oal_uint32 ul_vht_err_frm_num;
    oal_uint32 ul_lega_err_frm_num;
    oal_uint32 ul_rpt_phase_est;
    oal_uint32 ul_rpt_2x2_chan_cond;
    oal_uint32 ul_rx_dup_mpdu_cnt;
    oal_uint32 ul_rx_passed_mpdu_cnt;
    oal_uint32 ul_rx_failed_mpdu_cnt;
    oal_uint32 ul_rx_beacon_cnt;
    oal_uint32 ul_rpt_ampdu_retry_cnt;
    oal_uint32 ul_rpt_mac_auto_rst_cnt;
...
extern oal_void hi1151_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,oal_uint8 uc_tid, oal_uint8 uc_qos_flag, oal_uint8 uc_vap_index,oal_uint32 *pst_val_read);
...
extern oal_void hi1151_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_mode);
...
extern oal_void hi1102_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,oal_uint8 uc_tid, oal_uint8 uc_qos_flag, oal_uint8 uc_vap_index,oal_uint32 *pst_val_read);
...
extern oal_void hi1102_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_mode);
...
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
extern oal_void  hi1103_tx_clear_pdet_en(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru *pst_tx_dscr);
#endif
...
extern oal_void  hi1103_set_bss_color(hal_to_dmac_device_stru *pst_hal_device, hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_bss_color, oal_uint8 uc_partial_bss_color);
#endif
#ifdef _PRE_WLAN_FEATURE_CSI
...
extern oal_void hi1103_pow_set_pow_code_idx_same_in_tx_power(hal_tx_txop_tx_power_stru *pst_tx_power, oal_uint32 ul_pow_code);
...
#ifdef _PRE_WLAN_FEATURE_M2S
extern oal_void hi1103_update_datarate_by_chain(hal_to_dmac_device_stru *pst_hal_device);
#endif
...
extern oal_void hi1103_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_mode);
...
#endif
extern oal_void hi1103_rf_cali_realtime_entrance(hal_to_dmac_device_stru * OAL_CONST pst_hal_device, hal_pdet_info_stru * OAL_CONST pst_pdet_info, hal_dyn_cali_usr_record_stru * OAL_CONST pst_user_pow);
extern oal_void hi1103_init_dyn_cali_tx_pow(hal_to_dmac_device_stru *pst_hal_device);
#endif
#ifdef _PRE_WLAN_FEATURE_TPC_OPT
extern oal_void hi1103_update_upc_amend_by_sar(hal_to_dmac_device_stru *pst_hal_device);
#endif
#ifdef _PRE_WLAN_DFT_REG
