...
extern oal_uint8 g_auc_sar_ctrl_params[WLAN_RF_CHANNEL_NUMS][HAL_CUS_NUM_OF_SAR_PARAMS];
...
#define HAL_ANT_SWITCH_RSSI_MGMT_TH              10  /* 管理帧ant0与ant1相差10dB时切换到SISO */
...
#define HAL_M2S_CHECK_RSSI_SNR_ON(_pst_handler)   \
    ((0 != ((*(oal_uint8*)&((_pst_handler)->st_hal_m2s_fsm.st_m2s_mode))& WLAN_M2S_TRIGGER_MODE_RSSI_SNR)) ? OAL_TRUE : OAL_FALSE)
...
typedef enum {
    /* 1.RSSI模块 */
    HAL_M2S_EVENT_ANT_RSSI_MIMO_TO_MISO = 0,        /*  接收功率异常切换 */
    HAL_M2S_EVENT_ANT_RSSI_MIMO_TO_SISO_C0,
    HAL_M2S_EVENT_ANT_RSSI_MIMO_TO_SISO_C1,
    HAL_M2S_EVENT_ANT_RSSI_MISO_TO_SISO_C0,
    HAL_M2S_EVENT_ANT_RSSI_MISO_TO_SISO_C1,
    HAL_M2S_EVENT_ANT_RSSI_SISO_TO_MISO_C0,
    HAL_M2S_EVENT_ANT_RSSI_SISO_TO_MISO_C1,
    ...
    HAL_M2S_EVENT_DBDC_MIMO_TO_SISO,
    HAL_M2S_EVENT_DBDC_SISO_TO_MIMO,
...
#if defined(_PRE_PRODUCT_ID_HI110X_DEV) && defined(_PRE_WLAN_FEATURE_MU_TRAFFIC_CTL)
    /* 通过维护额外信息，实现对Rx描述符资源的分配进行更为精确的控制 */
    GET_DEV_RX_DSCR_ISR_INFO_CNT(pst_device, pst_rx_isr_info->uc_queue_id)--;
    GET_DEV_RX_DSCR_ISR_PKTS_NUM(pst_device, pst_rx_isr_info->uc_queue_id) = pst_rx_isr_info->us_dscr_num;
#endif
...
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
OAL_STATIC OAL_INLINE oal_void  hal_tx_clear_pdet_en(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru *pst_tx_dscr)
{
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV)
    HAL_PUBLIC_HOOK_FUNC(_tx_clear_pdet_en)(pst_hal_device, pst_tx_dscr);
#endif
}
#endif
...
OAL_STATIC OAL_INLINE oal_void hal_set_bss_color(hal_to_dmac_device_stru *pst_hal_device, hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_bss_color, oal_uint8 uc_partial_bss_color)
{
    HAL_PUBLIC_HOOK_FUNC(_set_bss_color)( pst_hal_device, pst_hal_vap, uc_bss_color, uc_partial_bss_color);
}
...
OAL_STATIC OAL_INLINE oal_void  hal_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,oal_uint8 uc_tid, oal_uint8 uc_qos_flag, oal_uint8 uc_vap_index,oal_uint32 *pst_val_read)
{
    HAL_PUBLIC_HOOK_FUNC(_get_tx_sequence_num)( pst_hal_device, uc_lut_index,uc_tid,uc_qos_flag,uc_vap_index,pst_val_read);
}
...
OAL_STATIC OAL_INLINE oal_void hal_rf_cali_realtime_entrance(hal_to_dmac_device_stru * OAL_CONST pst_hal_device, hal_pdet_info_stru * OAL_CONST pst_pdet_info, hal_dyn_cali_usr_record_stru * OAL_CONST pst_user_pow)
{
...
OAL_STATIC  OAL_INLINE oal_void hal_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_user_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_protocol_type)
{
    HAL_PUBLIC_HOOK_FUNC(_set_bfee_grouping_codebook)( pst_hal_device, uc_user_index, uc_min_group, uc_txbf_protocol_type);
}
...
OAL_STATIC OAL_INLINE oal_void hal_update_upc_amend_by_sar(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC(_update_upc_amend_by_sar)( pst_hal_device);
}
#endif
...
{
    HAL_PUBLIC_HOOK_FUNC(_get_rate_idx_pow)(pst_hal_device, uc_pow_idx, en_freq_band, pus_powr);
}
...
OAL_STATIC OAL_INLINE oal_void hal_update_datarate_by_chain(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC(_update_datarate_by_chain)(pst_hal_device);
}
#endif
