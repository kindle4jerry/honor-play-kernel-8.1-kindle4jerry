                   ...
                   oal_uint16               *pus_amsdu_maxsize)
{
    ...
    pst_ht_hdl->bit_sm_power_save = mac_ie_proc_sm_power_save_field(pst_mac_user_ap, uc_smps);
...
OAL_STATIC oal_uint32  mac_ie_check_proc_opmode_param(mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify)
{
    ...
    {
        OAM_WARNING_LOG4(pst_mac_user->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_check_proc_opmode_param::en_bandwidth_cap[%d],opmode bandwidth[%d],user spatial stream[%d],opmode rx nss[%d]!}",
...
oal_uint32  mac_ie_proc_opmode_field(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify)
{
    ...
    {
        OAM_WARNING_LOG0(pst_mac_user->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::mac_ie_check_proc_opmode_param return fail!}\r\n");
        return OAL_FAIL;
    }
    ...
    {
        OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_channel_width = [%x], pst_mac_user->en_avail_bandwidth = [%x]!}\r\n",
        ...
        OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::change bandwidth. en_bwcap_vap = [%x], pst_mac_user->en_avail_bandwidth = [%x]!}\r\n",
    ...
    if (1 == pst_opmode_notify->bit_rx_nss_type)
    {
        OAM_INFO_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_rx_nss_type == 1!}\r\n");
        ...
        if (pst_opmode_notify->bit_rx_nss != pst_mac_user->en_avail_bf_num_spatial_stream)
        {
            ...
            mac_user_avail_bf_num_spatial_stream(pst_mac_user, OAL_MIN(pst_mac_vap->en_vap_rx_nss, pst_opmode_notify->bit_rx_nss));
        }
    }
    else
    {
        ...
        {
            OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_rx_nss = [%x], pst_mac_user->en_avail_num_spatial_stream = [%x]!}\r\n",
            ...
            OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE, "{mac_ie_proc_opmode_field::change rss. pst_mac_vap->en_vap_rx_nss = [%x], pst_mac_user->en_avail_num_spatial_stream = [%x]!}\r\n",
