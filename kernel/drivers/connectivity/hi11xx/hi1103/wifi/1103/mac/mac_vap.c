...
mac_rx_ddc_switch_stru g_st_rx_ddc_switch = {0};
...
oal_void  mac_vap_init_mib_11ax(mac_vap_stru  *pst_mac_vap)
{
    ...
    mac_mib_set_he_MaxAMPDULength(pst_mac_vap,5);/* 2^(13+factor)-1字节 */
...
{
    /*en_dot11MgmtOptionBSSTransitionActivated 初始化时为FALSE,由定制化或命令打开 */
    mac_mib_set_MgmtOptionBSSTransitionActivated(pst_vap, OAL_FALSE);
