...
OAL_STATIC oal_void mac_set_he_mac_capinfo_field(oal_void *pst_vap, oal_uint8 *puc_buffer)
{
    ...
    ***************************************************************************/
    ...
    pst_he_mac_capinfo->bit_32bit_ba_bitmap_support                = 1;
    ...
    pst_he_mac_capinfo->bit_ofdma_ra_support                       = 1;
...
OAL_STATIC oal_void mac_set_he_phy_capinfo_field(oal_void *pst_vap, oal_uint8 *puc_buffer)
{
    ...
    /*B12:device type,0==B类设备*/
    pst_he_phy_capinfo->bit_device_class                 = 0;
    ...
    /*B14:HE SU PPDU with 1x HE-LTF + 0.8us GI, 认证用例5.31支持       */
    pst_he_phy_capinfo->bit_he_su_ppdu_1x_ltf            = 1;

    /*B17:NDP With 4x HE-LTF And 3.2us GI   */
    pst_he_phy_capinfo->bit_ndp_4x                       = 1;
    ...
    /*B34-36:Beamformee STS ≤ 80MHz*/
    pst_he_phy_capinfo->bit_beamformee_sts_below_80mhz   = 4;
    ...
    /*B48:Ng = 16 SU Feedback  */
    pst_he_phy_capinfo->bit_ng16_su_feedback             = 1;

    /*B49:CodeBook Size(Φ,Ψ)={7,5} SU Feedback  */
    pst_he_phy_capinfo->bit_codebook_75_feedback         = 1;

    /*B50:Triggered SU Beamforming Feedback  */
    pst_he_phy_capinfo->bit_trigger_su_beamform_feedback = 1;

    /*B51:Triggered MU Beamforming Feedback  */
    pst_he_phy_capinfo->bit_trigger_mu_beamform_feedback = 1;

    /*B54:Partial Bandwidth DL MU-MIMO  */
    pst_he_phy_capinfo->bit_partial_bandwidth_dl_mu_mimo = 1;

    /*B58:HE SU PPDU And HE MU PPDU with 4x HE-LTF + 0.8usGI */
    pst_he_phy_capinfo->bit_4x_he_ltf_8us_gi             = 1;

    /*B59-61:Max Nc 实际值为4,字段设置-1   */
    pst_he_phy_capinfo->bit_max_nc                       = 3;

    /*B64:HE ER SU PPDU with 4x HE-LTF + 08us   */
    pst_he_phy_capinfo->bit_he_er_su_ppdu_4x_ltf         = 1;

    /*B65:20/40MHz HE PPDU 2.4G   */
    pst_he_phy_capinfo->bit_20mhz_in_40mhz_he_ppdu_2g    = 1;

    /*B68:HE ER SU PPDU with 1x HE-LTF and 0.8us GI   */
    pst_he_phy_capinfo->bit_he_er_su_ppdu_1x_ltf         = 1;

    /*B69:Midamble Rx 2x and 1x HE-LTF  */
    pst_he_phy_capinfo->bit_midamble_rx_2x_1x_he_ltf     = 1;
