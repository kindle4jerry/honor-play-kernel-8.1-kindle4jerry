...
uint8 g_auc_cust_nvram_info[WLAN_CFG_DTS_NVRAM_RATIO_PA5GA0_BAND1][DY_CALI_PARAMS_LEN]  = {{0}};  /* NVRAM数组 */
...
OAL_STATIC wlan_cfg_cmd g_ast_wifi_config_priv[] =
{
    ...
    {"btcoex_mask",                 WLAN_CFG_PRIV_BTCOEX_MASK},
...
OAL_STATIC wlan_cfg_cmd g_ast_nvram_config_ini[NVRAM_PARAMS_PWR_INDEX_BUTT] =
{
    ...
    {OAL_PTR_NULL,  NVRAM_PARAMS_INDEX_23},
    {OAL_PTR_NULL,  NVRAM_PARAMS_INDEX_24},
    /* FCC & SAR */
    {"fcc_txpwr_limit_5g_20m_0",  NVRAM_PARAMS_INDEX_25},
    {"fcc_txpwr_limit_5g_20m_1",  NVRAM_PARAMS_INDEX_26},
    {"fcc_txpwr_limit_5g_40m",    NVRAM_PARAMS_INDEX_27},
    {"fcc_txpwr_limit_5g_80m",    NVRAM_PARAMS_INDEX_28},
    {"fcc_txpwr_limit_5g_160m",   NVRAM_PARAMS_INDEX_29},
    {"fcc_txpwr_limit_24g_ch1",   NVRAM_PARAMS_INDEX_30},
    {"fcc_txpwr_limit_24g_ch2",   NVRAM_PARAMS_INDEX_31},
    {"fcc_txpwr_limit_24g_ch3",   NVRAM_PARAMS_INDEX_32},
    {"fcc_txpwr_limit_24g_ch4",   NVRAM_PARAMS_INDEX_33},
    {"fcc_txpwr_limit_24g_ch5",   NVRAM_PARAMS_INDEX_34},
    {"fcc_txpwr_limit_24g_ch6",   NVRAM_PARAMS_INDEX_35},
    {"fcc_txpwr_limit_24g_ch7",   NVRAM_PARAMS_INDEX_36},
    {"fcc_txpwr_limit_24g_ch8",   NVRAM_PARAMS_INDEX_37},
    {"fcc_txpwr_limit_24g_ch9",   NVRAM_PARAMS_INDEX_38},
    {"fcc_txpwr_limit_24g_ch10",  NVRAM_PARAMS_INDEX_39},
    {"fcc_txpwr_limit_24g_ch11",  NVRAM_PARAMS_INDEX_40},
    {"fcc_txpwr_limit_24g_ch12",  NVRAM_PARAMS_INDEX_41},
    {"fcc_txpwr_limit_24g_ch13",  NVRAM_PARAMS_INDEX_42},
    {"sar_txpwr_ctrl_5g_c0_band1",   NVRAM_PARAMS_INDEX_43},
    {"sar_txpwr_ctrl_5g_c0_band2",   NVRAM_PARAMS_INDEX_44},
    {"sar_txpwr_ctrl_5g_c0_band3",   NVRAM_PARAMS_INDEX_45},
    {"sar_txpwr_ctrl_5g_c0_band4",   NVRAM_PARAMS_INDEX_46},
    {"sar_txpwr_ctrl_5g_c0_band5",   NVRAM_PARAMS_INDEX_47},
    {"sar_txpwr_ctrl_5g_c0_band6",   NVRAM_PARAMS_INDEX_48},
    {"sar_txpwr_ctrl_5g_c0_band7",   NVRAM_PARAMS_INDEX_49},
    {"sar_txpwr_ctrl_5g_c1_band1",   NVRAM_PARAMS_INDEX_50},
    {"sar_txpwr_ctrl_5g_c1_band2",   NVRAM_PARAMS_INDEX_51},
    {"sar_txpwr_ctrl_5g_c1_band3",   NVRAM_PARAMS_INDEX_52},
    {"sar_txpwr_ctrl_5g_c1_band4",   NVRAM_PARAMS_INDEX_53},
    {"sar_txpwr_ctrl_5g_c1_band5",   NVRAM_PARAMS_INDEX_54},
    {"sar_txpwr_ctrl_5g_c1_band6",   NVRAM_PARAMS_INDEX_55},
    {"sar_txpwr_ctrl_5g_c1_band7",   NVRAM_PARAMS_INDEX_56},
    {"sar_txpwr_ctrl_2g_c0",         NVRAM_PARAMS_INDEX_57},
    {"sar_txpwr_ctrl_2g_c1",         NVRAM_PARAMS_INDEX_58},
};
...
OAL_STATIC oal_void original_value_for_nvram_params(oal_void)
{
    ...
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_30] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_31] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_32] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_33] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_34] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_35] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_36] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_37] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_38] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_39] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_40] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_41] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_42] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_43] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_44] = 0xFFFFFF;
    ...
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_53] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_54] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_55] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_56] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_57] = 0xFFFFFF;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_58] = 0xFFFFFF;
}
...
OAL_STATIC oal_int32 hwifi_custom_adapt_priv_ini_param(wlan_cfg_priv_id_uint8 uc_cfg_id, oal_uint8 *puc_data, oal_uint32 *pul_len)
{
    ...
    switch(uc_cfg_id)
    {
        ...
        case WLAN_CFG_PRIV_BTCOEX_MASK:
            st_syn_msg.en_syn_id = CUSTOM_CFGID_PRIV_BTCOEX_MASK_ID;
...
int32 hwifi_custom_adapt_device_priv_ini_param(oal_uint8 *puc_data)
{
    ...
    hwifi_custom_adapt_priv_ini_param(WLAN_CFG_PRIV_BTCOEX_MASK, puc_data + ul_data_len, &ul_data_len);
...
oal_int32 hwifi_custom_host_read_dyn_cali_nvram(oal_void)
{
    ...
    oal_int8      *pc_ctx;
    oal_int8      *pc_token;
    oal_uint8      auc_cust_nvram_tmp[DY_CALI_PARAMS_LEN] = {0};
    oal_uint8      auc_cust_nvram_info[WLAN_CFG_DTS_NVRAM_RATIO_PA5GA1+1][DY_CALI_PARAMS_LEN];  /* NVRAM数组 */
    oal_int16      s_params[DY_CALI_PARAMS_NUM*DY_CALI_PARAMS_TIMES] = {0};
    ...
    {
        l_ret = read_conf_from_nvram(auc_cust_nvram_tmp, DY_CALI_PARAMS_LEN,
        ...
        puc_str = OAL_STRSTR(auc_cust_nvram_tmp, g_ast_wifi_nvram_cfg_handler[uc_idx].puc_param_name);
    ...
    /* 拟合系数 */
    for (uc_idx = WLAN_CFG_DTS_NVRAM_RATIO_PA2GCCKA0; uc_idx <= WLAN_CFG_DTS_NVRAM_RATIO_PA5GA1; uc_idx++)
    {
        l_ret = read_conf_from_nvram(auc_cust_nvram_tmp, DY_CALI_PARAMS_LEN,
                                     g_ast_wifi_nvram_cfg_handler[uc_idx].ul_nv_map_idx,
        ...
        {
            OAL_IO_PRINT( "hwifi_custom_host_read_dyn_cali_nvram::get [%s]\n!", pc_token);
            *(s_params + uc_param_idx) = (oal_int16)oal_strtol(pc_token, OAL_PTR_NULL, 10);
            pc_token = oal_strtok(OAL_PTR_NULL, pc_sep, &pc_ctx);
            uc_param_idx++;
        }
        ...
        while (uc_times_idx--)
        {
            if (0 == s_params[(uc_times_idx)*DY_CALI_PARAMS_TIMES])
            {
                OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_custom_host_read_dyn_cali_nvram::check NV id[%d]!",
                               g_ast_wifi_nvram_cfg_handler[uc_idx].ul_nv_map_idx);
                OAL_MEMZERO(auc_cust_nvram_info[uc_idx], DY_CALI_PARAMS_LEN*OAL_SIZEOF(oal_uint8));
...
OAL_STATIC int32 hwifi_config_init_fcc_txpwr_nvram(void)
{
    ...
    int32     al_nvram_params[NVRAM_PARAMS_INDEX_43 - NVRAM_PARAMS_INDEX_25] = {0};
    int32    *pul_fcc_txpwr_limit_params = al_nvram_params;

    for (uc_cfg_id = NVRAM_PARAMS_INDEX_25; uc_cfg_id <= NVRAM_PARAMS_INDEX_42; uc_cfg_id++)
    {
    ...
    pul_fcc_txpwr_limit_params++;
    oal_memcopy(g_st_cust_nv_params.auc_5g_fcc_txpwr_limit_params_40M, pul_fcc_txpwr_limit_params,
                CUS_NUM_5G_40M_SIDE_BAND*OAL_SIZEOF(oal_uint8));
    pul_fcc_txpwr_limit_params++;
    oal_memcopy(g_st_cust_nv_params.auc_5g_fcc_txpwr_limit_params_80M, pul_fcc_txpwr_limit_params,
                CUS_NUM_5G_80M_SIDE_BAND*OAL_SIZEOF(oal_uint8));
    pul_fcc_txpwr_limit_params++;
...
OAL_STATIC oal_int32 hwifi_config_init_sar_ctrl_nvram(void)
{
    ...
    for (uc_cfg_id = NVRAM_PARAMS_INDEX_43; uc_cfg_id <= NVRAM_PARAMS_INDEX_58; uc_cfg_id++)
    {
...
int hwifi_get_cfg_params(void)
{
    ...
    for (l_cfg_id = 0; l_cfg_id <= WLAN_CFG_DTS_NVRAM_RATIO_PA5GA1; l_cfg_id++)
    {
