...
/* Version Information */
#define DRIVER_VERSION "v2.09.00 (2017/08/21)"
...
static int rtl8153_pre_reset(struct usb_interface *intf)
{
...
static int rtl8153_post_reset(struct usb_interface *intf)
{
	struct r8152 *tp = usb_get_intfdata(intf);
	struct net_device *netdev;
...
static int rtl8153_reset_resume(struct usb_interface *intf)
{
	struct r8152 *tp = usb_get_intfdata(intf);
...
static struct usb_driver rtl8153_driver = {
	...
	.reset_resume =	rtl8153_reset_resume,
	.pre_reset =	rtl8153_pre_reset,
	.post_reset =	rtl8153_post_reset,
	.supports_autosuspend = 1,
	.disable_hub_initiated_lpm = 1,
};

module_usb_driver(rtl8153_driver);
