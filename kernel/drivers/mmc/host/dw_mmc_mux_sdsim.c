...
int config_sdsim_gpio_mode(enum sdsim_gpio_mode gpio_mode)
{
	if(SDSIM_MODE_GPIO_DETECT == gpio_mode)
	{
		...
		set_sd_sim_group_io_register(GPIO_160, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_25MA_1 );
		...
		set_sd_sim_group_io_register(GPIO_163, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
	...
	else if(SDSIM_MODE_SD_NORMAL == gpio_mode)
	{
		...
		set_sd_sim_group_io_register(GPIO_160, FUNCTION1, PULL_TYPE_NP, DRIVER_STRENGTH_25MA_1 );
		set_sd_sim_group_io_register(GPIO_161, FUNCTION1, PULL_TYPE_PU, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_162, FUNCTION1, PULL_TYPE_PU, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_163, FUNCTION1, PULL_TYPE_PU, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_164, FUNCTION1, PULL_TYPE_PU, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_165, FUNCTION1, PULL_TYPE_PU, DRIVER_STRENGTH_11MA_1 );
	...
	else if(SDSIM_MODE_SD_IDLE == gpio_mode)
	{
		...
		set_sd_sim_group_io_register(GPIO_160, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_25MA_1 );
		set_sd_sim_group_io_register(GPIO_161, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_162, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_163, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_164, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
		set_sd_sim_group_io_register(GPIO_165, FUNCTION0, PULL_TYPE_NP, DRIVER_STRENGTH_11MA_1 );
