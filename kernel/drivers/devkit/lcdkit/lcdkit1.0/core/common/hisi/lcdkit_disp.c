...
static void lcdkit_read_project_id(void)
{
	...
	if(!strncmp(lcdkit_info.panel_infos.panel_name,"BOE_HX83112A 6.30' VIDEO TFT 1080 x 2340",strlen(lcdkit_info.panel_infos.panel_name)))
		{
			strncpy(g_project_id,"JHSN591300",strlen("JHSN591300"));
	}
